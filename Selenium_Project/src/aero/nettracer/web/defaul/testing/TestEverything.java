...
@SuiteClasses({
	...
	Def_PasswordResetNTTest.class, Def_Logout.class, AD_Login.class, AD_VerifyText_TaskManager.class,
	B6_Login.class, Def_Logout.class, B6_LoginFailure.class, B6_LoginTest.class, 
	Def_PasswordResetNTTest.class, Def_Logout.class, B6_Login.class, B6_VerifyText_TaskManager.class,
