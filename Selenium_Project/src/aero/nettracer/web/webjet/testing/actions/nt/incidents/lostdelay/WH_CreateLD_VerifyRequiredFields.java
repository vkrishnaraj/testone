...
public class WH_CreateLD_VerifyRequiredFields extends DefaultSeleneseTestCase {
		...
		if (checkNoErrorPage()) {
			...
			if (checkNoErrorPage()) {
				...
				if (checkNoErrorPage()) {
					...
					Settings.INCIDENT_ID_WH = incident_id;
					System.out.println("WH: Lost/Delay Incident Created: " + Settings.INCIDENT_ID_WH);
