package aero.nettracer.web.webjet.testing.actions.nt.onhands;
...
public class WH_CreateOHD_VerifyRequiredFields extends DefaultSeleneseTestCase {
	...
	public void testAD_CreateOHD_VerifyRequiredFields() throws Exception {
		...
		if (checkNoErrorPage()) {
			...
			if (checkNoErrorPage()) {
				...
				Settings.ONHAND_ID_WH = onhand_id;
				System.out.println("WH: Onhand Created: " + Settings.ONHAND_ID_WH);
