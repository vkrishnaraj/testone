package aero.nettracer.web.webjet.testing.actions.nt.taskman;
...
public class WH_InboxMessage extends DefaultSeleneseTestCase {
	...
	public void testVerifyText() throws Exception {
		...
		if (checkNoErrorPage()) {
			...
			if (checkNoErrorPage()) {
				...
				if (Settings.INCIDENT_ID_WH != null && !Settings.INCIDENT_ID_WH.equals("")) {
					inc_id = Settings.INCIDENT_ID_WH;
					has_inc_id = true;
				}
