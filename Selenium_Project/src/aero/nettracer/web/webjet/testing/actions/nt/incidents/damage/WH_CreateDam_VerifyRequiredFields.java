package aero.nettracer.web.webjet.testing.actions.nt.incidents.damage;
...
public class WH_CreateDam_VerifyRequiredFields extends DefaultSeleneseTestCase {
		...
		if (checkNoErrorPage()) {
			...
			if (checkNoErrorPage()) {
				...
				if (checkNoErrorPage()) {
					...
					Settings.DAMAGE_ID_WH = damage_id;
					System.out.println("WH: Damaged Incident Created: " + Settings.DAMAGE_ID_WH);
