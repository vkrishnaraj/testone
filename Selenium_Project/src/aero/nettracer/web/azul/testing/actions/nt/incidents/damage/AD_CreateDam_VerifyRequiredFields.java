	...
	public void testVerifyText() throws Exception {
		...
		if (checkNoErrorPage()) {
			...
			if (checkNoErrorPage()) {
				...
				selenium.click("name=saveButton");
				assertEquals("Damage Description is required.",
						selenium.getAlert());
				...
				if (checkNoErrorPage()) {
					...
					Settings.DAMAGE_ID_AD = damage_id;
					System.out.println("AD: Damaged Incident Created: "
							+ Settings.DAMAGE_ID_AD);
					selenium.click("//td[@id='middlecolumn']/table/tbody/tr/td/h1/p/a");
					waitForPageToLoadImproved();
				} else {
					System.out
							.println("!!!!!!!!!!!!!!! - Create Damaged Success Page Failed To Load. Error Page Loaded Instead. - !!!!!!!!!!!!!!!!!!");
					verifyTrue(false);
				}
			} else {
				System.out
						.println("!!!!!!!!!!!!!!! - Edit Damaged Page Failed To Load. Error Page Loaded Instead. - !!!!!!!!!!!!!!!!!!");
				verifyTrue(false);
			}
		} else {
			System.out
					.println("!!!!!!!!!!!!!!! - Prepopulate Damaged Page Failed To Load. Error Page Loaded Instead. - !!!!!!!!!!!!!!!!!!");
			verifyTrue(false);
		}
	}
