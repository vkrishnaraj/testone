...
// -->
  ...
  <html:form action="addFound.do" method="post">
    <tr>
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <h1>
            ...
            (
            <bean:write name="LostAndFoundForm" property="file_ref_number" />
            )
          </h1>
        </div>
    ...
    <tr>
      <td colspan="3" id="navmenucell">
        <div class="menu">
          <dl>
            <dd>
              <A HREF='addFound.do?file_ref_number=<bean:write name="LostAndFoundForm" property="file_ref_number"/>'><span class="aa">&nbsp;
                  <br />
                  &nbsp;</span>
                <span class="bb"><bean:message key="menu.found_report" /></span>
                <span class="cc">&nbsp;
                  <br />
                  &nbsp;</span></a>
            </dd>
      ...
      <td id="middlecolumn">
        ...
        <div id="maincontent">
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            <input type="hidden" name="file_ref_number" value="<bean:write name="LostAndFoundForm" property="file_ref_number"/>">
