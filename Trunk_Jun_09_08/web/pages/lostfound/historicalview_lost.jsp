...
function CBG_check(obj) {
  ...
  <html:form action="addLost.do" method="post">
    <tr>
    ...
    <tr>
      <td colspan="3" id="navmenucell">
        <div class="menu">
          <dl>
            <dd>
              <A HREF='addLost.do?file_ref_number=<bean:write name="LostAndFoundForm" property="file_ref_number"/>'><span class="aa">&nbsp;
                  <br />
                  &nbsp;</span>
                <span class="bb"><bean:message key="menu.lost_report" /></span>
                <span class="cc">&nbsp;
                  <br />
                  &nbsp;</span></a>
            </dd>
