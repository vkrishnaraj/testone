    ...
    <tr>
      <td align="center" valign="top">
        ...
        <html:hidden property="save" value = ""/>
                <html:hidden property="save" value = ""/>
        <html:button property="saveButton" styleId="button" onclick="changebutton(); if(validateReqBDO(document.BDOForm)) {window.onbeforeunload = function() {}; document.BDOForm.submit();} else {undoChangebutton();}">
