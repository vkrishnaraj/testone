      ...
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <logic:present name="express" scope="request">
            <h1>
              <bean:message key="header.express_ma" />
            </h1>
          </logic:present>
          ...
          <table id="pageheaderright">
            <tr>
              ...
              <logic:notEqual name="incidentForm" property="incident_ID" value="">
                ...
                <td>
                  <a href='#' onclick="openReportWindow('searchIncident.do?receipt=1&toprint=<%=ReportingConstants.MISSING_RECEPIT_RPT%>&incident=<bean:write name="incidentForm" property="incident_ID" />','MissingReceipt',800,600);return false;"><img src="deployment/main/images/nettracer/icon_printrecpt.gif" width="12" height="12"></a>
                </td>
                <td>
                  <a href='#' onclick="openReportWindow('searchIncident.do?receipt=1&toprint=<%=ReportingConstants.MISSING_RECEPIT_RPT%>&incident=<bean:write name="incidentForm" property="incident_ID" />','MissingReceipt',800,600);return false;"><bean:message key="link.lost_delay_receipt" /></a>
                  &nbsp;
                </td>
              </logic:notEqual>
              <jsp:include page="/pages/includes/mail_incl.jsp" />
...
%>
              <dd>
                <a href="missing.do?close=1"><span class="aa">&nbsp;
                    <br />
                    &nbsp;</span>
    ...
    <tr>
      ...
      <td id="middlecolumn">
        ...
        <h1 class="green">
          ...
          <a href="#" onclick="openHelp('pages/WebHelp/nettracerhelp.htm#missing_articles_reports/creating_missing_article_reports.htm');return false;"><img src="deployment/main/images/nettracer/button_help.gif" width="20" height="21" border="0"></a>
        </h1>
          ...
          <table class="<%=cssFormClass %>" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td>
                ...
                <br>
                <html:text name="article" property="dispurchasedate" size="15" maxlength="10" styleClass="textfield" indexed="true" /><img src="deployment/main/images/calendar/calendar_icon.gif" id="calendar5<%= i %>" name="calendar5<%= i %>" height="15" width="20" border="0" onmouseover="this.style.cursor='hand'" onClick="cal1xx.select2(document.incidentForm, '<%= "article[" + i + "].dispurchasedate" %>','calendar5<%= i %>','<%= a.getDateformat().getFormat() %>'); return false;"></td>
              <td>
            ...
            <tr>
              <td colspan=4>
                ...
                <br>
                <html:textarea name="article" property="description" cols="80" rows="5" styleClass="textarea_medium" indexed="true" />
              </td>
            </tr>
            <tr>
              <td colspan=4>
