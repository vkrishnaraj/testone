        	...
        	<c:choose>
			    ...
			    <c:otherwise>
                  ...
                  <c:if test="${not empty labellist}">
		          	<display:table id="ohd" name="requestScope.labellist" requestURI="/label.do" sort="external" 
		          		...
		          		<display:column titleKey="colname.select" headerClass="header">
		          			<input type="checkbox" name="label_id" value="<bean:write name="ohd" property="id"/>"/>
		          		</display:column>
						...
						<display:column titleKey="header.action" headerClass="header">
		          			<a href="label.do?label_id=<bean:write name="ohd" property="id"/>&action=edit" ><bean:message key="edit" /></a>
		          			|
		          			<a href="label.do?label_id=<bean:write name="ohd" property="id"/>&action=delete" ><bean:message key="delete" /></a>
			          	</display:column>
		            </display:table>
		          </c:if>
         		</c:otherwise>
