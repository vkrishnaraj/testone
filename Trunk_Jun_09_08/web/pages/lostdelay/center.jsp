 ...
 %>
		...
		<html:hidden property="save" value="" disabled="true" />
			...
			<html:hidden property="savetowt" value="" disabled="true" />
						<html:button styleId="wtbutton" property="savetowtButton"
							onclick="disableButtons(); if(validatereqFields(this.form, 'lostdelay') != false && validateRest(this.form) != false && confirmWt() != false) {this.form.savetowt.disabled = false; window.onbeforeunload = function() {}; this.form.submit();} else {enableButtons(); this.form.savetowt.disabled = true; return false;}">
			...
			<html:hidden property="amendWT" value="" disabled="true" />
			      ...
			      onclick="disableButtons(); if( validatereqFields(this.form, 'lostdelay') != false && validateRest(this.form) != false) {this.form.amendWT.disabled = false; window.onbeforeunload = function() {}; this.form.submit();} else {enableButtons(); this.form.amendWT.disabled = true; return false;}">
                        <bean:message key="button.amendWT" />
                      </html:button>
                      <% } %>
                    </c:if>
		...
		<%-- <html:submit property="savetracing" styleId="button" onclick="return validatereqFields(this.form, 'lostdelay');"> --%>
			<html:hidden property="savetracing" value="" disabled="true" />
                <html:button property="savetracingButton" styleClass="button" styleId="saveButton" onclick="disableButtons(); if(validatereqFields(this.form, 'lostdelay') != false && validateRest(this.form) != false) {this.form.savetracing.disabled = false; window.onbeforeunload = function() {}; this.form.submit();} else {enableButtons(); this.form.savetracing.disabled = true; return false;}">
