      ...
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <logic:present name="express" scope="request">
            <h1>
              <bean:message key="header.express_lostdelay" />
            </h1>
          </logic:present>
...
%>
                <dd>
                  <a href='bdo.do?mbr_id=<bean:write name="incidentForm" property="incident_ID"/>'><span class="aa">&nbsp;
                      <br />
                      &nbsp;</span>
                ...
                <logic:notEqual name="incidentForm" property="incident_ID" value="">
                  <logic:notEmpty name="claimcheck" property="OHD_ID">
                    ...
                    <logic:notPresent name="cantmatch" scope="request">
                      <input type="submit" name="unmatchclaim<%= i %>" value='<bean:message key="button.un_match"/>' id="button">
                    </logic:notPresent>
                  </logic:notEmpty>
                  <logic:notPresent name="cantmatch" scope="request">
                    <logic:empty name="claimcheck" property="OHD_ID">
                      ...
                      :
                      <html:text name="claimcheck" property="tempOHD_ID" size="13" maxlength="13" styleClass="textfield" indexed="true" onblur="fillzero(this,13);" />
                      <input type="submit" name="matchclaim<%= i %>" value='<bean:message key="button.do_match"/>' id="button">
                    </logic:empty>
                  </logic:notPresent>
                </logic:notEqual>
              </td>
      ...
      <logic:equal name="incidentForm" property="allow_remark_update" value="1">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="top">
              <br>
              <logic:present name="incident" scope="session">
