    ...
    <tr>
      ...
      <td id="middlecolumn">
        ...
        <div id="maincontent">
          ...
          <% java.util.List lossCodes=LossCodeBMO.getCompanyCodes(a.getStation().getCompany().getCompanyCode_ID(), TracingConstants.LOST_DELAY, true, a); %>
            ...
            <table class="<%=cssFormClass %>" cellspacing="0" cellpadding="0">
			  ...
			  <bean:write name="theitem" property="arrivedonairline_ID"/>
					...
					<td>
					  ...
					  <br>
			  <bean:write name="theitem" property="arrivedonflightnum"/>
			  	</td>
					<td>
