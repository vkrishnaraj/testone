    ...
    <tr>
      ...
      <td id="middlecolumn">
        ...
        <div id="maincontent">
          ...
          <c:forEach items="${incidentForm.itemlist}" var="theitem" varStatus="status" >
			  <table class="<%=cssFormClass %>" cellspacing="0" cellpadding="0">
				...
				<a name="additem${status.index}"></a>
				  ...
				  <tr>
					<td>
						<b><bean:message key="colname.arr_airline_id" /></b>
			  <br>
			  <c:out value="${theitem.arrivedonairline_ID}" default="Not Set"/>
					</td>
					<td>
						<b><bean:message key="colname.ldclose.arr_flight_num" /></b>
					  <br>
			  <c:out value="${theitem.arrivedonflightnum}" default="Not Set"/>
					</td>
					<td>
						<b><bean:message key="colname.arr_date" />
					  (
					  <%= a.getDateformat().getFormat() %>)</b>
					  <br>
			  <c:out value="${theitem.disarrivedondate}" default="Not Set"/>
					  </td>
				  </tr>
			  </table>
          </c:forEach>
