...
function CBG_check(obj) {
  ...
  sections.addToGroup("damaged_info");
          ...
          <dl>
            <dd>
              <a href='searchIncident.do?incident=<bean:write name="incidentForm" property="incident_ID"/>'><span class="aa">&nbsp;
                  <br />
                  &nbsp;</span>
                <span class="bb"><bean:message key="menu.damaged_report" /></span>
                <span class="cc">&nbsp;
                  <br />
                  &nbsp;</span></a>
            </dd>
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="100%" nowrap>
                ...
                &nbsp;&nbsp;
                <br>
                <INPUT TYPE=CHECKBOX NAME="damaged_info" <% if (request.getAttribute("damaged_info") != null || (request.getAttribute("all") == null || (request.getAttribute("all") != null && ((String)request.getAttribute("all")).equals ("1")))) { %> CHECKED <% } %> onClick="sections.check(this);">
