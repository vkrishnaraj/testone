...
<%
	...
	Integer rowCount = Integer.valueOf(request.getAttribute("rowcount").toString());
	Integer pageSize = Integer.valueOf(request.getAttribute("rowsperpage").toString());
%>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function setCommand(command) {
		document.getElementById('create').value = command;
	}
...
<html:form action="searchDocumentTemplate.do" method="post">
	<input type="hidden" id="create" name="create" value="false" />
        ...
        <div id="maincontent">
            ...
            <table class="form2" cellspacing="0" cellpadding="0">
            	...
            	<tr>
            		<td align="center" colspan="3">
            			<input type="submit" class="button" value='<bean:message key="button.search" />' />
            			&nbsp;&nbsp;
            			<input type="submit" class="button" value='<bean:message key="button.create" />' onclick="setCommand('<%=TracingConstants.TRUE %>')" />
              		</td>
            	</tr>
            </table>
            ...
            <logic:present name="resultList" scope="request">
            	<h1 class="green">
              	...
              	<a name="result"></a>
              	<display:table requestURI="/searchDocumentTemplate.do" name="requestScope.resultList" sort="external" size="<%=rowCount %>" pagesize="<%=pageSize %>"
