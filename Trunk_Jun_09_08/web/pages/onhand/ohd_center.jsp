...
<%
	...
	OnHandForm onHandForm = (OnHandForm) session
			.getAttribute("OnHandForm");
%>
<!-- Calendar includes -->
...
<html:form action="addOnHandBag.do" method="post"
	...
	<tr>
		...
		<dl>
			...
			&nbsp;</span> <span class="bb"><bean:message key="menu.bag_itinerary" /></span>
			<span class="cc">&nbsp; <br />
			&nbsp;</span></a></dd>
			<dd><a href="#centralbag"><span class="aa">&nbsp; <br />
			&nbsp;</span> <span class="bb"><bean:message
				key="menu.central_baggage_inventory" /></span> <span class="cc">&nbsp;
			<br />
			&nbsp;</span></a></dd>
			<dd><a href="#remarks"><span class="aa">&nbsp; <br />
			&nbsp;</span> <span class="bb"><bean:message key="menu.remarks" /></span> <span
				class="cc">&nbsp; <br />
			&nbsp;</span></a></dd>
			<%
			...
			&nbsp;</span> <span class="bb"><bean:message key="menu.photos" /></span> <span
				class="cc">&nbsp; <br />
			&nbsp;</span></a></dd>
			<%
				}
			...
			<logic:notEqual name="OnHandForm" property="ohd_id" value="">
				<%
					if (UserPermissions.hasPermission(
								...
								if (a.getCompanycode_ID().equals(
										onHandForm.getHolding_company())
				...
				<dd><a
					...
					class="aa">&nbsp; <br />
				&nbsp;</span> <span class="bb"><bean:message key="menu.bdo" /></span> <span
					class="cc">&nbsp; <br />
				&nbsp;</span></a></dd>
				<%
					}
				...
				<dd><a
					...
					class="aa">&nbsp; <br />
				&nbsp;</span> <span class="bb"><bean:message key="menu.tasks" /></span> <span
					class="cc">&nbsp; <br />
				&nbsp;</span></a></dd>
				<dd><a href="#" onclick="gotoHistoricalReport();"><span
					class="aa">&nbsp; <br />
				&nbsp;</span> <span class="bb"><bean:message key="menu.history" /></span>
				<span class="cc">&nbsp; <br />
				&nbsp;</span></a></dd>
			</logic:notEqual>
		</dl>
	...
	<tr>
		...
		<p align="right"><logic:notEqual name="OnHandForm"
			...
			<c:if test="${!empty OnHandForm.wt_id }">
				<%
					if (UserPermissions
												.hasPermission(
														TracingConstants.SYSTEM_COMPONENT_NAME_WORLD_TRACER_FWD,
														a)) {
				%>
			...
			<c:if test="${!empty OnHandForm.wt_id }">
				<%
					if (UserPermissions
												.hasPermission(
														TracingConstants.SYSTEM_COMPONENT_NAME_WORLD_TRACER_ROH,
														a)) {
				%>
				<logic:notEqual name="OnHandForm" property="wt_id" value="">
                        &nbsp;|&nbsp;
			...
			<%
				if (UserPermissions
								.hasPermission(
										TracingConstants.SYSTEM_COMPONENT_NAME_SCANNER_DATA,
										a)) {
			%>
		...
		<table class="form2_ohd" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td><bean:message key="colname.agent_initials" /> <br>
				<html:text property="agent_initials" size="4" styleClass="textfield"
					disabled="true" /></td>
		...
		<table class="form2_ohd" cellspacing="0" cellpadding="0">
			<tr>
				<td><bean:message key="colname.status" /> <br>
				<logic:notEqual name="OnHandForm" property="ohd_id" value="">
				...
				<html:select name="OnHandForm" property="disposal_status.status_ID"
					styleClass="dropdown">
				...
				<td><bean:message key="colname.bag_arrived_date.req" /> ( <%=a.getDateformat().getFormat()%>)
				<br>
			...
			<tr>
				...
				<html:text property="pnr" size="22" maxlength="20"
					styleClass="textfield" /></td>
			...
			<tr>
				...
				<html:text property="manufacturer_other" size="25" maxlength="100"
					styleClass="textfield" /></div>
				</td>
			</tr>
		</table>
		<br>
		...
		<h1 class="green"><bean:message key="header.passenger_info" /> <a
			href="#"
		...
		<span class="reqfield">*</span> <bean:message key="Required" /> <logic:iterate
			id="passenger" name="OnHandForm" property="passengerList" indexId="i"
			type="com.bagnet.nettracer.tracing.db.OHD_Passenger">
			<table class="form2_ohd" cellspacing="0" cellpadding="0">
				<tr>
					<td colspan=5>
					<%
 ...
 %>
				...
				<tr>
					...
					<td colspan=2><bean:message key="colname.first_name" /> <br>
				...
				<logic:present name="passenger" property="addresses">
					<logic:iterate indexId="k" name="passenger" id="addresses"
						...
						<tr>
							<td colspan=2><bean:message key="colname.street_addr1" /> <br>
							<html:text
								property='<%="addresses["
													+ (i.intValue() * 20 + k
															.intValue())
							...
							<td colspan=3><bean:message key="colname.street_addr2" /> <br>
							<html:text
								property='<%="addresses["
													+ (i.intValue() * 20 + k
															.intValue())
						...
						<tr>
							...
							</logic:equal> <logic:equal name="addresses" property="countrycode_ID" value="">
								<html:select
									property='<%="addresses["
																	+ (i
																			.intValue() * 20 + k
							...
							</logic:equal> <logic:notEqual name="addresses" property="countrycode_ID"
								value="">
								<logic:notEqual name="addresses" property="countrycode_ID"
									value="US">
									<html:select
										property='<%="addresses["
																		+ (i
		...
		<br>
		<a name="itinerary"></a>
		<h1 class="green"><bean:message key="header.bag_itinerary" /> <a
			href="#"
			...
			<table class="form2_ohd" cellspacing="0" cellpadding="0">
				<tr>
					...
					<html:hidden name="itinerarylist" property="itinerarytype"
						...
						property="legfrom" size="3" maxlength="3" styleClass="textfield"
						indexed="true" /> <a href="#"
						onclick="openWindow('pages/popups/airportcodes.jsp?key=itinerarylist[<%=k%>].legfrom','airportcode',500,600);return false;"><img
						src="deployment/main/images/nettracer/airport_codes.gif" border=0></a>
					/ <html:text name="itinerarylist" property="legto" size="3"
					...
					<br>
					<html:text name="itinerarylist" property="disdepartdate" size="11"
						maxlength="10" styleClass="textfield" indexed="true" /><img
						src="deployment/main/images/calendar/calendar_icon.gif"
					...
					<br>
					<html:text name="itinerarylist" property="disarrivedate" size="11"
						maxlength="10" styleClass="textfield" indexed="true" /><img
						src="deployment/main/images/calendar/calendar_icon.gif"
				...
				<tr>
					...
					<html:select name="itemlist" property="OHD_categorytype_ID"
						...
						<html:options collection="categorylist"
							property="OHD_CategoryType_ID" labelProperty="categorytype" />
					</html:select></td>
			...
			<logic:iterate id="remark" indexId="i" name="OnHandForm"
              ...
              <bean:write name="agent" property="station.stationcode" />
					...
					<tr>
						...
						<%
							if (a.getGroup().getDescription()
														.equalsIgnoreCase("Admin")
														|| remark.getRemark_ID() == 0) {
						%> <%
 	String remarkDescription = "remark[" + i
 									+ "].remarktext";
				...
				<tr>
					...
					<logic:notEmpty name="OnHandForm" property="status">
						...
						<%
							if (UserPermissions
												.hasPermission(
														TracingConstants.SYSTEM_COMPONENT_NAME_WORLD_TRACER,
														a)) {
											if (a.getStation().getCompany().getVariable()
													.getWt_enabled() == 1) {
												if (a.getStation().getCompany().getVariable()
...
<c:if test="${empty pendingWtAction}">
							<logic:notEmpty name="OnHandForm" property="wt_id">
								<logic:notEqual name="OnHandForm" property="status.status_ID"
									value="<%=""
