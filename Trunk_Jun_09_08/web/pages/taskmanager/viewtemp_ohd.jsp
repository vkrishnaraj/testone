    ...
    <tr>
      ...
      <td id="middlecolumn">
        ...
        <div id="maincontent">
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td colspan=4>
                ...
                <br>
                <html:text property="s_time" size="12" maxlength="11" styleClass="textfield" /><img src="deployment/main/images/calendar/calendar_icon.gif" id="calendar" name="calendar" height="15" width="20" border="0" onmouseover="this.style.cursor='hand'" onClick="cal1xx.select(document.viewTemporaryOnHandsForm.s_time,'calendar','<%= a.getDateformat().getFormat() %>'); return false;">-
                <html:text property="e_time" size="12" maxlength="11" styleClass="textfield" /><img src="deployment/main/images/calendar/calendar_icon.gif" id="calendar2" name="calendar2" height="15" width="20" border="0" onmouseover="this.style.cursor='hand'" onClick="cal1xx.select(document.viewTemporaryOnHandsForm.e_time,'calendar2','<%= a.getDateformat().getFormat() %>'); return false;"></td>
            </tr>
            <tr>
          ...
          <br>
          <h1 class="green">
            <bean:message key="Temporary_On-hand" />
            <a href="#" onclick="openHelp('pages/WebHelp/nettracerhelp.htm#task_manager/view_reports.htm#view temp on-hands');return false;"><img src="deployment/main/images/nettracer/button_help.gif" width="20" height="21" border="0"></a>
          </h1>
          <font color=red>
            <logic:messagesPresent message="true"><html:messages id="msg" message="true"><br/><bean:write name="msg"/><br/></html:messages></logic:messagesPresent>
          </font>
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            <tr>
              <td>
                <strong>
                  <a href="#" onclick="sortOHD('ohd');"><bean:message key="colname.on_hand_report_number" /></a>
                </strong>
              </td>
              <td>
                <strong>
                  <a href="#" onclick="sortOHD('createdate');"><bean:message key="colname.incident_create_date" /></a>
                </strong>
              </td>
              <td>
                <strong>
