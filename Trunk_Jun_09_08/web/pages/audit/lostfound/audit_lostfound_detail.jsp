...
%>
<%
          if (file_ref_number != null) {
%>
            <input type="hidden" name="file_ref_number" value="<%= file_ref_number %>">
<%
          }
%>
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <logic:iterate id="alf" name="auditlostfoundlist">
              <tr>
                <td>
                  <input type="checkbox" name="audit_lost_found_id" value="<bean:write name="alf" property="audit_lost_found_id"/>">
                </td>
                <td>
                  <logic:equal name="alf" property="report_type" value="1">
                    <A HREF="addLost.do?file_ref_number=<bean:write name="alf" property="file_ref_number"/>"><bean:write name="alf" property="file_ref_number" /></a>
                  </logic:equal>
                  <logic:equal name="alf" property="report_type" value="0">
                    <A HREF="addFound.do?file_ref_number=<bean:write name="alf" property="file_ref_number"/>"><bean:write name="alf" property="file_ref_number" /></a>
                  </logic:equal>
                </td>
                <td>
                  <bean:write name="alf" property="displaytime_modified" />
                </td>
                <td>
                  <bean:write name="alf" property="modifying_agent.username" />
                </td>
              </tr>
            </logic:iterate>
            <tr>
            ...
            <tr>
              <td colspan="11" align="center">
                ...
                &nbsp;
                <INPUT type="button" Id="button" value="<bean:message key="button.compare.file.details"/>" onClick="submitCompareLFDform()">
              </td>
            </tr>
          </table>
        </logic:present>
