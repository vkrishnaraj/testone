  ...
  <html:form action="audit_station.do" method="post">
    ...
    <tr>
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <h1>
            <bean:message key="header.audit_station_modification_history" />
          </h1>
        </div>
    ...
    <tr>
      ...
      <td id="middlecolumn">
        ...
        <div id="maincontent">
<%
          String station_ID = (String)request.getAttribute("station_ID");
%>
<%
          if (station_ID != null) {
%>
...
%>
          <logic:present name="auditstationlist" scope="request">
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <logic:iterate id="aa" name="auditstationlist">
              <tr>
                <td>
                  <input type="checkbox" name="id" value="<bean:write name="aa" property="audit_station_id"/>">
                </td>
                <td>
                  <bean:write name="aa" property="stationcode" />
                </td>
                <td>
            ...
            <tr>
              <td colspan="11" align="center">
                ...
                &nbsp;
                <INPUT type="button" Id="button" value="<bean:message key="button.compare.file.details"/>" onClick="submitCompareStationform()">
              </td>
            </tr>
          </table>
        </logic:present>
