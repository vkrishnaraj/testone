...
// -->
  ...
  <html:form action="audit_airport.do" method="post">
    <tr>
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <h1>
            <bean:message key="header.audit_airport" />
          </h1>
        </div>
      ...
      <td colspan="3" id="navmenucell">
        <div class="menu">
          <dl>
            ...
            <dd>
              <a href="audit_airport.do"><span class="aab">&nbsp;
                  <br />
                  &nbsp;</span>
                <span class="bbb"><bean:message key="Audit_Airport" />
                  <br>
                  &nbsp;</span>
                <span class="ccb">&nbsp;
                  <br />
            ...
            <table class="form2" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                  ...
                  <br>
                  <html:text styleClass="textfield" name="auditAirportForm" property="airport_code" size="3" maxlength="3" />
                </td>
                <td colspan=2>
                ...
                <tr>
                  <td colspan=3>
                    ...
                    <br>
                    <html:text property="s_createtime" size="12" maxlength="11" styleClass="textfield" /><img src="deployment/main/images/calendar/calendar_icon.gif" id="calendar" name="calendar" height="15" width="20" border="0" onmouseover="this.style.cursor='hand'" onClick="cal1xx.select(document.auditAirportForm.s_createtime,'calendar','<%= a.getDateformat().getFormat() %>'); return false;">-
                    <html:text property="e_createtime" size="12" maxlength="11" styleClass="textfield" /><img src="deployment/main/images/calendar/calendar_icon.gif" id="calendar2" name="calendar2" height="15" width="20" border="0" onmouseover="this.style.cursor='hand'" onClick="cal1xx.select(document.auditAirportForm.e_createtime,'calendar2','<%= a.getDateformat().getFormat() %>'); return false;"></td>
                </tr>
                <tr>
              ...
              <logic:present name="airportList" scope="request">
              <!-- result -->
              <h1 class="green">
              ...
              <table class="form2" cellspacing="0" cellpadding="0">
                ...
                <logic:iterate id="airport" name="airportList">
                  <tr>
                    <td>
                      <A HREF="audit_airport.do?detail=1&id=<bean:write name="airport" property="id"/>"><bean:write name="airport" property="airport_code" /></a>
                    </td>
                    <td>
                    ...
                    <td>
                      <bean:write name="airport" property="reason_modified" />
                      &nbsp;
                    </td>
                  </tr>
                </logic:iterate>
