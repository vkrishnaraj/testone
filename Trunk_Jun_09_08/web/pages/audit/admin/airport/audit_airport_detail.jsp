    ...
    <tr>
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <h1>
            <bean:message key="header.audit_airport_modification_history" />
          </h1>
        </div>
...
%>
          <logic:present name="auditairportlist" scope="request">
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <logic:iterate id="aa" name="auditairportlist">
              <tr>
                <td>
                  <input type="checkbox" name="id" value="<bean:write name="aa" property="audit_id"/>">
                </td>
                <td>
                  <bean:write name="aa" property="airport_code" />
                </td>
                <td>
            ...
            <tr>
              <td colspan="11" align="center">
                ...
                &nbsp;
                <INPUT type="button" Id="button" value="<bean:message key="button.compare.file.details"/>" onClick="submitCompareAirportform()">
              </td>
            </tr>
          </table>
        </logic:present>
