        ...
        <div id="maincontent">
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <logic:iterate id="audit_lfi" name="compareList" scope="request">
                <td>
                  <bean:write name="audit_lfi" property="airport_desc" />
                  &nbsp;
                </td>
              </logic:iterate>
            </tr>
            ...
            <tr>
              ...
              <logic:iterate id="audit_lfi" name="compareList" scope="request">
                <td>
                  <logic:equal name="audit_lfi" property="country" value="0">
                    <bean:message key="airportadmin.country.us" />
                  </logic:equal>
                  <logic:equal name="audit_lfi" property="country" value="1">
                    <bean:message key="airportadmin.country.canada" />
                  </logic:equal>
                  <logic:equal name="audit_lfi" property="country" value="2">
                    <bean:message key="airportadmin.country.other" />
                  </logic:equal>
                </td>
              </logic:iterate>
            </tr>
