  ...
  <html:form action="audit_company.do" method="post">
    ...
    <tr>
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <h1>
            <bean:message key="header.audit_company_modification_history" />
          </h1>
        </div>
    ...
    <tr>
      ...
      <td id="middlecolumn">
        ...
        <div id="maincontent">
          <logic:present name="auditcompanylist" scope="request">
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <logic:iterate id="aa" name="auditcompanylist">
              <tr>
                <td>
                  <input type="checkbox" name="id" value="<bean:write name="aa" property="audit_id"/>">
                </td>
                <td>
                  <bean:write name="aa" property="companyCode_ID" />
                </td>
                <td>
                  <bean:write name="aa" property="time_modified" />
                </td>
                <td>
            ...
            <tr>
              <td colspan="11" align="center">
                ...
                &nbsp;
                <INPUT type="button" Id="button" value="<bean:message key="button.compare.file.details"/>" onClick="submitCompareCompanyform()">
              </td>
            </tr>
          </table>
        </logic:present>
