    ...
    <tr>
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <h1>
            <bean:message key="header.audit_shift_modification_history" />
          </h1>
        </div>
...
%>
          <logic:present name="auditworkshiftlist" scope="request">
          <!-- result -->
          <a name="result"></a>
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <logic:iterate id="aa" name="auditworkshiftlist">
              <tr>
                <td>
                  <input type="checkbox" name="id" value="<bean:write name="aa" property="audit_shift_id"/>">
                </td>
                <td>
                  <bean:write name="aa" property="shift_code" />
                </td>
                <td>
            ...
            <tr>
              <td colspan="11" align="center">
                ...
                &nbsp;
                <INPUT type="button" Id="button" value="<bean:message key="button.compare.file.details"/>" onClick="submitCompareShiftform()">
              </td>
            </tr>
          </table>
        </logic:present>
