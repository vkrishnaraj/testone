    ...
    <tr>
      <td colspan="3" id="pageheadercell">
        <div id="pageheaderleft">
          <h1>
            <bean:message key="header.audit_ohd_modification_history" />
          </h1>
        </div>
...
<%
          if (ohd_id != null) {
%>
            <input type="hidden" name="ohd_ID" value="<%= ohd_id %>">
<%
          }
%>
          ...
          <table class="form2" cellspacing="0" cellpadding="0">
            ...
            <logic:iterate id="aohd" name="auditonhandlist">
              <tr>
                <td>
                  <input type="checkbox" name="audit_id" value="<bean:write name="aohd" property="audit_ohd_id"/>">
                </td>
                <td>
                  <A HREF="addOnHandBag.do?ohd_ID=<bean:write name="aohd" property="OHD_ID"/>"><bean:write name="aohd" property="OHD_ID" /></a>
                </td>
                <td>
                  <bean:write name="aohd" property="displaytime_modified" />
                </td>
                <td>
                  <bean:write name="aohd" property="modifying_agent.username" />
                </td>
              </tr>
            </logic:iterate>
            <tr>
            ...
            <tr>
              <td colspan="11" align="center">
                ...
                &nbsp;
                <INPUT type="button" Id="button" value="<bean:message key="button.compare.file.details"/>" onClick="submitCompareOHDform()">
              </td>
            </tr>
          </table>
        </logic:present>
