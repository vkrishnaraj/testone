...
<div id="header">
	<ul class="tabs">
		<span onclick="switchView(this)" id="searchShow" ><li  class="active" rel="search">Search
		</li></span>
		<span onclick="switchView(this)" id="historyShow"><li rel="history">History
		</li></span>
	</ul>
</div>
