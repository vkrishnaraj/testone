        ...
        <div id="maincontent">
          <h1 class="green">
			...
			if (request.getParameter("ahl_id") != null && request.getParameter("ahl_id").length() > 9) {
				out.println("&nbsp;&nbsp;( " + request.getParameter("ahl_id") + " )");	
			} else if (request.getParameter("ohd_id") != null && request.getParameter("ohd_id").length() > 9) {
				out.println("&nbsp;&nbsp;( " + request.getParameter("ohd_id") + " )");	
			}
			%>
		 ...
		 <a href="worldtraceraf.do?viewaction=<%=request.getAttribute("wt_type") %>"><bean:message key="link.back_to_all" /></a>
		 </div>
		 <%
			}
		 %>
          ...
          <font color=red>
           ...
           <logic:notEqual name="wt_id_specific" value="1" scope="request">
	            <table class="form2" cellspacing="0" cellpadding="0">
	              <tr>
	                <td>
	                 <a href="worldtraceraf.do?viewaction=<%=header_text %>&d=1">Day 1:</a>
	                </td>
	                <td>
	                 <a href="worldtraceraf.do?viewaction=<%=header_text %>&d=2">Day 2:</a>
	                </td>
	                <td>
	                 <a href="worldtraceraf.do?viewaction=<%=header_text %>&d=3">Day 3:</a>
	                </td>
	                <td>
	                 <a href="worldtraceraf.do?viewaction=<%=header_text %>&d=4">Day 4:</a>
	                </td>
	                <td>
	                 <a href="worldtraceraf.do?viewaction=<%=header_text %>&d=5">Day 5:</a>
	                </td>
	                <td>
	                 <a href="worldtraceraf.do?viewaction=<%=header_text %>&d=6">Day 6:</a>
	                </td>
	                <td>
	                 <a href="worldtraceraf.do?viewaction=<%=header_text %>&d=7">Day 7:</a>
	                </td>
	              </tr>
	            </table>
            </logic:notEqual>
            <logic:present name="resultlist" scope="request">
              <h1 class="green">
                ...
                <a href="#" onclick="openHelp('pages/WebHelp/NetTracer.htm#Retrieve.htm#Worldtracer_actionfiles');return false;"><img src="deployment/main/images/nettracer/button_help.gif" width="20" height="21" border="0"></a>
              </h1>
              <a name="result"></a>
            ...
            <input type="hidden" name="viewaction" value="<%=request.getParameter("viewaction") %>">
            <input type="hidden" name="d" value="<%=request.getParameter("d") %>">
            <input type="hidden" name="wt_id_specific" value="<%=request.getAttribute("wt_id_specific") %>">
            <input type="hidden" name="ahl_id" value="<%=request.getParameter("ahl_id") %>">
            <input type="hidden" name="ohd_id" value="<%=request.getParameter("ohd_id") %>">
             </html:form>
