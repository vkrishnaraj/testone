...
<script type="text/javascript" >
	...
	function getTask() {
		...
		window.location = "customerCommunicationsTasks.do?gettask=1&fraudReview=1";
	}
	
</script>
<html:form action="fraudReview.do" method="post" >
	...
	<tr>
		<td id="middlecolumn">
	    	<div id="maincontent">
		     	...
		     	<h1 class="green">
		         	<bean:message key="header.fraud.review" />
		       	</h1>
		       	<logic:notPresent name="results" scope="request">
		       		<div style="text-align:center;color:green;" >
		       			<br>
		       			<bean:message key="message.no.fraud.review" />
		       		</div>
		       	</logic:notPresent>
		       	<logic:present name="results" scope="request">
	              	...
	              	<display:table requestURI="/fraudReview.do" name="requestScope.results" sort="external" class="form2" cellspacing="0" cellpadding="0" id="<%=TracingConstants.TABLE_ID_FRAUD_REVIEW %>" defaultsort="1" >
	          			<display:column titleKey="colname.disburse.id" property="id" href="customerCommunicationsTasks.do?gettask=1&fraudReview=1" paramId="communicationsId"  paramProperty="id" sortable="true" sortName="id" />
	          			...
	          			<display:column titleKey="colname.disburse.create.by" property="specialist" sortable="true" sortName="specialist" />
	          			<display:column titleKey="colname.disburse.updated" property="dispTaskDate" sortable="true" sortName="date" />
	 			    	<display:footer>
			               	<tr>
				                <td colspan="7">
