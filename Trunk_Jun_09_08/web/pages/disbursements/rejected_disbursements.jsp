...
<html:form action="rejectedDisbursements.do" method="post" >
	...
	<tr>
		<td id="middlecolumn">
	    	<div id="maincontent">
		     	...
		     	<h1 class="green">
		         	<bean:message key="header.rejected.disbursements" />
		       	</h1>
		       	<logic:notPresent name="results" scope="request">
		       		<div style="text-align:center;color:green;" >
		       			<br>
		       			<bean:message key="message.no.rejected.disbursements" />
		       		</div>
		       	</logic:notPresent>
		       	<logic:present name="results" scope="request">
	              	<display:table requestURI="/rejectedDisbursements.do" name="requestScope.results" sort="external" class="form2" cellspacing="0" cellpadding="0" id="<%=TracingConstants.TABLE_ID_REJECTED_DISBURSEMENTS %>" defaultsort="1" >
	          			<display:column titleKey="colname.disburse.id" property="id" href="customerCommunicationsRejected.do" paramId="taskId" paramProperty="id" sortable="true" sortName="id" />
	          			...
	          			<display:column titleKey="colname.disburse.reject.status" sortable="true" sortName="status" >
