...
<!--------------------- end new menu ------------------- //-->   
  ...
  if (request.getAttribute("errortype") != null) {
		...
		if (request.getAttribute("errortype").equals("500")) {
	%>
  		<jsp:include page="/pages/customerrpages/error500_incl.jsp" />
	<%
		} else if (request.getAttribute("err403") != null) {
	%>
      <jsp:include page="/pages/customerrpages/error403_incl.jsp" />
	<%
		} else {
	%>
      <jsp:include page="/pages/customerrpages/error404_incl.jsp" />
	<%
		}
	} else {
	%>
  ...
  <tr> 
    ...
    <bean:message key="copyright.line2"/></div></td> 
      <td align=right width=1><bean:message key="footer.current_version"/></td>
      </tr>
      </table>
    </td>
  </tr> 
