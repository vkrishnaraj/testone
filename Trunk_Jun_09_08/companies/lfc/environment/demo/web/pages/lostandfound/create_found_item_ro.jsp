     		...
     		<div id="maincontent">
					        ...
					        <table class="<%=cssFormClass %>" cellspacing="0" cellpadding="0" >
			        			<tr>
			        				...
			        				<td class="header" style="width:30%;" >
			        					<bean:message key="header.found.item" />:&nbsp;
			        					<bean:write name="match" property="found.id" />
			        				</td>
			        				<td class="header" style="width:30%;" >
    			...
    			<span class="reqfield">*</span>
         		...
         		<table class="<%=cssFormClass %>" cellspacing="0" cellpadding="0">
            		...
            		<logic:notEmpty name="foundItemForm" property="found.id">
						<td>
							<bean:message key="colname.lf.report.id" />&nbsp;<span class="reqfield">*</span>
         					<br>
         					<% if (enableIdField) { %>
								<html:text name="foundItemForm" property="found.id" styleClass="textfield" />
         					<% } else { %>
								<html:text name="foundItemForm" property="found.id" disabled="true" styleClass="disabledtextfield" />
							<% } %>
         				</td>
					</logic:notEmpty>
					<logic:empty name="foundItemForm" property="found.id">
						<td>
							<bean:message key="colname.lf.report.id" />&nbsp;<span class="reqfield">*</span>
         					<br>
							<html:text name="foundItemForm" property="found.id" styleClass="textfield" />
