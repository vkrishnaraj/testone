						...
						<td>
							...
							<br/>
         					<html:select name="foundItemForm" property="found.companyId" styleClass="dropdown" >
         						<html:option value="<%=TracingConstants.LF_DEMO_COMPANY_ID %>">Company A</html:option>
         						<html:option value="<%=TracingConstants.LF_DEMO_COMPANY_ID %>">Company B</html:option>
         					</html:select>
						</td>
						<td>
