      ...
      <tr>
        <td align="center" colspan=2>
          ...
          <tr>
            ...
            <td>
              <SELECT NAME="companyCode" class="dropdown">
              	<option value="US" selected="selected">USAir DEV</option>
          ...
          <tr>
            ...
            <H1><font color="red">Warning: This is a development environment only.  Do not enter real claims or bags.</font></H2>
              <p>
                <font color=red>
