...
<%@ taglib uri="/tags/struts-nested" prefix="nested" %>
  <tr>
	...
	*
    ...
    <td>
      <html:text styleClass="textfield" name="companyForm" property="min_interim_approval_incidental" size="4" maxlength="4" />
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
	...
	*
    ...
    <td>
      <html:text styleClass="textfield" name="companyForm" property="min_interim_approval_cc_refund" size="4" maxlength="4" />
    </td>
  </tr>
