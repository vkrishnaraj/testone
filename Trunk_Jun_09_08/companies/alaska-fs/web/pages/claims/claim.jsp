				           ...
				           <tr>
								<td colspan="2">
				             	...
				             	<td colspan="3">
				             		...
				             		<br />
				                  	<input type="text" disabled="true" name="person[<%=i %>].disDateOfBirth" size="12" maxlength="11" value="<%=person.getDisDateOfBirth() == null ? "" : person.getDisDateOfBirth() %>" class="textfield" />
				             	</td>
				           </tr>
				           <tr>
				           		<td colspan="2">
				                ...
				                <td>
					              ...
					              <tr>
								  	...
								  	<td>
								  		...
								  		<br />
										<select disabled="true"  name="receipt[<%=i %>].ccType" class="dropdown" >
								  	...
								  	<td >
										...
										<br/>
								  		<input disabled="true" type="text" name="receipt[<%=i %>].ccLastFour" maxlength="4" size="4" value="<%=((FsReceipt) receipt).getCcLastFour() == null ? "" : ((FsReceipt) receipt).getCcLastFour() %>" class="textfield">
									</td>
									<td >
										<bean:message key="claim.colname.cc_expdate" />
										<br/>
								  		<select disabled="true" name="receipt[<%=i %>].ccExpMonth" class="dropdown" >
										...
										&nbsp;/&nbsp;
								  		<select disabled="true" name="receipt[<%=i %>].ccExpYear" class="dropdown" >
             	...
             	<td colspan="5">
					...
					<tr>
						<td colspan=2>
							<bean:message key="claim.colname.cc_type" />
							<br/>
							<html:select name="claimForm" property="claim.file.incident.reservation.ccType" disabled="true" styleClass="dropdown" >
								<html:option value="">
						...
						<td>
							...
							<br/>
							<html:text name="claimForm" disabled="true" property="claim.file.incident.reservation.redactedCcNumber" size="20" maxlength="16" styleClass="textfield" />
						</td>
						<td>
							<bean:message key="claim.colname.cc_num.last.four" />
							<br/>
							<html:text name="claimForm" disabled="true" property="claim.file.incident.reservation.ccNumLastFour" size="10" maxlength="4" styleClass="textfield" />
						</td>
						<td>
							<bean:message key="claim.colname.cc_expdate" />
							<br/>
							<html:select name="claimForm" disabled="true" property="claim.file.incident.reservation.ccExpMonth" styleClass="dropdown" >
								<html:option value="">
							...
							&nbsp;
							<html:select disabled="true" name="claimForm" property="claim.file.incident.reservation.ccExpYear" styleClass="dropdown" >
								<html:option value="">
