...
public class AirlineCodesTest {
	...
	public void testGetTwoLetterAirlineCode1() {
		...
		assertEquals("DL", LookupAirlineCodes.getTwoLetterAirlineCode(threeDigitCode));
	}
	
	@Test
	public void testGetTwoLetterAirlineCode2() {
		String threeDigitCode = "037";
		assertEquals("US", LookupAirlineCodes.getTwoLetterAirlineCode(threeDigitCode));
	}

	@Test
	public void testGetTwoLetterAirlineCode3() {
		String threeDigitCode = "000";
		assertEquals(null, LookupAirlineCodes.getTwoLetterAirlineCode(threeDigitCode));
	}
	...
	public void testGetTwoLetterAirlineCode5() {
		...
		assertEquals("B6", LookupAirlineCodes.getTwoLetterAirlineCode(threeDigitCode));
	}
	...
	public void testGetTwoLetterAirlineCode6() {
		...
		assertEquals("6B", LookupAirlineCodes.getTwoLetterAirlineCode(threeDigitCode));
	}
	
	@Test
	public void testGetThreeDigitTicketingCode1() {
		String twoCharacterCode = "DL";
		assertEquals("006", LookupAirlineCodes.getThreeDigitTicketingCode(twoCharacterCode));
	}	
	
	@Test
	public void testGetThreeDigitTicketingCode2() {
		String twoCharacterCode = "US";
		assertEquals("037", LookupAirlineCodes.getThreeDigitTicketingCode(twoCharacterCode));
	}	
	
	@Test
	public void testGetThreeDigitTicketingCode3() {
		String twoCharacterCode = "XX";
		assertEquals(null, LookupAirlineCodes.getThreeDigitTicketingCode(twoCharacterCode));
	}	
	...
	public void testGetThreeDigitTicketingCode5() {
		...
		assertEquals("279", LookupAirlineCodes.getThreeDigitTicketingCode(twoCharacterCode));
	}	
	
	@Test
	public void testGetThreeDigitTicketingCode6() {
		String twoCharacterCode = "6B";
		assertEquals("951", LookupAirlineCodes.getThreeDigitTicketingCode(twoCharacterCode));
	}	
	
	@Test
	public void testGetTwoCharacterBagTag1() throws BagtagException {
		String bagTag = "0006123456";
		assertEquals("DL123456", LookupAirlineCodes.getTwoCharacterBagTag(bagTag));
	}
