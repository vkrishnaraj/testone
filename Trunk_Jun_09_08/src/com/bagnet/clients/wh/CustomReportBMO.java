...
public class CustomReportBMO implements com.bagnet.nettracer.integrations.reports.CustomReportBMO {
	...
	private String createWHDailyStatusReport(StatReportDTO srDTO, String resourceKey, String rootpath, HttpServletRequest request, Agent user) {
		...
		try {
			drb.addColumn(resources.getString("report.wh.daily.status.mbr"), "mbr", String.class.getName(), 110, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.type"), "type", String.class.getName(), 65, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.status"), "status", String.class.getName(), 45, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.name"), "name", String.class.getName(), 75, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.airline"), "airline", String.class.getName(), 40, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.flight"), "flight", Integer.class.getName(), 40, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.origin"), "origin", String.class.getName(), 35, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.destination"), "destination", String.class.getName(), 35, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.route"), "route", String.class.getName(), 65, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.open.station"), "openStation", String.class.getName(), 45, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.open.user"), "openUser", String.class.getName(), 50, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.open.date"), "openDate", String.class.getName(), 70, detailStyle, header);
			...
			drb.addColumn(resources.getString("report.wh.daily.status.close.date"), "closeDate", String.class.getName(), 70, detailStyle, header);
			...
			drb.addColumn(resources.getString("report.wh.daily.status.fault.station"), "faultStation", String.class.getName(), 45, detailStyle, header);
			drb.addColumn(resources.getString("report.wh.daily.status.fault.code"), "faultCode", Integer.class.getName(), 40, detailStyle, header);
