...
public class ClientUtilsImpl implements ClientUtils {
	...
	public String getReportMethodName(int methodType) {
		...
		switch (methodType) {
			...
			case TracingConstants.REPORT_METHOD_PHONE:
				return TracingConstants.REPORT_METHOD_NAME_PHONE;
	...
	public int getReportMethodType(String methodName) {
		...
		if (methodName != null && !methodName.trim().isEmpty()) {
			...
			} else if (methodName.equals(TracingConstants.REPORT_METHOD_NAME_PHONE)) {
				type = TracingConstants.REPORT_METHOD_PHONE;
	...
	public List<LabelValueBean> getReportMethodsList(String locale) {
		...
		result.add(getLabelValueBean(resources.getString("select.phone"), String.valueOf(TracingConstants.REPORT_METHOD_PHONE)));
