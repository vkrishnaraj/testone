 ...
 */
public class GetAdvancedIncidentPVDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument
{
    
    public GetAdvancedIncidentPVDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETADVANCEDINCIDENTPV$0 = 
        new javax.xml.namespace.QName("http://passengerview.ws.nettracer.bagnet.com", "getAdvancedIncidentPV");
    
    
    /**
     * Gets the "getAdvancedIncidentPV" element
     */
    public com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument.GetAdvancedIncidentPV getGetAdvancedIncidentPV()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument.GetAdvancedIncidentPV target = null;
            target = (com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument.GetAdvancedIncidentPV)get_store().find_element_user(GETADVANCEDINCIDENTPV$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetAdvancedIncidentPV(com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument.GetAdvancedIncidentPV getAdvancedIncidentPV)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument.GetAdvancedIncidentPV)get_store().add_element_user(GETADVANCEDINCIDENTPV$0);
            }
            target.set(getAdvancedIncidentPV);
        }
    }
     ...
     */
    public com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument.GetAdvancedIncidentPV addNewGetAdvancedIncidentPV()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetAdvancedIncidentPVImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVDocument.GetAdvancedIncidentPV
    {
        
        public GetAdvancedIncidentPVImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName DONOTAUTHORIZE$4 = 
        ...
        public boolean getDoNotAuthorize()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(DONOTAUTHORIZE$4, 0);
                if (target == null)
                {
                    return false;
                }
        ...
        public org.apache.xmlbeans.XmlBoolean xgetDoNotAuthorize()
        {
            synchronized (monitor())
            {
                ...
                target = (org.apache.xmlbeans.XmlBoolean)get_store().find_element_user(DONOTAUTHORIZE$4, 0);
                return target;
            }
        }
        ...
        public void setDoNotAuthorize(boolean doNotAuthorize)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(DONOTAUTHORIZE$4);
                }
        ...
        public void xsetDoNotAuthorize(org.apache.xmlbeans.XmlBoolean doNotAuthorize)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlBoolean)get_store().add_element_user(DONOTAUTHORIZE$4);
                }
