 ...
 */
public class GetAdvancedIncidentPVResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVResponseDocument
{
    
    public GetAdvancedIncidentPVResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETADVANCEDINCIDENTPVRESPONSE$0 = 
        new javax.xml.namespace.QName("http://passengerview.ws.nettracer.bagnet.com", "getAdvancedIncidentPVResponse");
    ...
    public com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVResponseDocument.GetAdvancedIncidentPVResponse getGetAdvancedIncidentPVResponse()
    {
        ...
        {
            check_orphaned();
            com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVResponseDocument.GetAdvancedIncidentPVResponse target = null;
            target = (com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVResponseDocument.GetAdvancedIncidentPVResponse)get_store().find_element_user(GETADVANCEDINCIDENTPVRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetAdvancedIncidentPVResponse(com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVResponseDocument.GetAdvancedIncidentPVResponse getAdvancedIncidentPVResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVResponseDocument.GetAdvancedIncidentPVResponse)get_store().add_element_user(GETADVANCEDINCIDENTPVRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class GetAdvancedIncidentPVResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.passengerview.GetAdvancedIncidentPVResponseDocument.GetAdvancedIncidentPVResponse
    {
        
        public GetAdvancedIncidentPVResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
