 ...
 */
public class GetIncidentPVResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.passengerview.GetIncidentPVResponseDocument {
    private static final javax.xml.namespace.QName GETINCIDENTPVRESPONSE$0 = new javax.xml.namespace.QName("http://passengerview.ws.nettracer.bagnet.com",
            "getIncidentPVResponse");

    public GetIncidentPVResponseDocumentImpl(
    ...
    public com.bagnet.nettracer.ws.passengerview.GetIncidentPVResponseDocument.GetIncidentPVResponse getGetIncidentPVResponse() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.passengerview.GetIncidentPVResponseDocument.GetIncidentPVResponse target =
                null;
            target = (com.bagnet.nettracer.ws.passengerview.GetIncidentPVResponseDocument.GetIncidentPVResponse) get_store()
                                                                                                                     .find_element_user(GETINCIDENTPVRESPONSE$0,
                    0);
     ...
     */
    public void setGetIncidentPVResponse(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.passengerview.GetIncidentPVResponseDocument.GetIncidentPVResponse) get_store()
                                                                                                                         .add_element_user(GETINCIDENTPVRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class GetIncidentPVResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.passengerview.GetIncidentPVResponseDocument.GetIncidentPVResponse {
        ...
        public com.bagnet.nettracer.ws.core.pojo.xsd.WSPVIncident getReturn() {
            synchronized (monitor()) {
                ...
                target = (com.bagnet.nettracer.ws.core.pojo.xsd.WSPVIncident) get_store()
