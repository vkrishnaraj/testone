 ...
 */
public class DeleteFileResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument {
    private static final javax.xml.namespace.QName DELETEFILERESPONSE$0 = new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com",
            "deleteFileResponse");
    ...
    public com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument.DeleteFileResponse getDeleteFileResponse() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument.DeleteFileResponse target =
                null;
            target = (com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument.DeleteFileResponse) get_store()
                                                                                                              .find_element_user(DELETEFILERESPONSE$0,
                    0);
     ...
     */
    public void setDeleteFileResponse(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument.DeleteFileResponse) get_store()
                                                                                                                  .add_element_user(DELETEFILERESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class DeleteFileResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument.DeleteFileResponse {
