 ...
 */
public class AuthPassengerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument {
    private static final javax.xml.namespace.QName AUTHPASSENGER$0 = new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com",
            "authPassenger");
    ...
    public com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument.AuthPassenger getAuthPassenger() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument.AuthPassenger target =
                null;
            target = (com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument.AuthPassenger) get_store()
                                                                                                    .find_element_user(AUTHPASSENGER$0,
                    0);
     ...
     */
    public void setAuthPassenger(
        com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument.AuthPassenger authPassenger) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument.AuthPassenger) get_store()
                                                                                                        .add_element_user(AUTHPASSENGER$0);
            }
     ...
     * This is a complex type.
     */
    public static class AuthPassengerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument.AuthPassenger {
        private static final javax.xml.namespace.QName PASSENGERLASTNAME$0 = new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com",
                "passengerLastName");
        private static final javax.xml.namespace.QName INCIDENTID$2 = new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com",
                "incidentId");
        private static final javax.xml.namespace.QName AUTH$4 = new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com",
                "auth");
        ...
        public java.lang.String getPassengerLastName() {
            synchronized (monitor()) {
                ...
                target = (org.apache.xmlbeans.SimpleValue) get_store()
                                                               .find_element_user(PASSENGERLASTNAME$0,
                        0);
        ...
        public void setPassengerLastName(java.lang.String passengerLastName) {
            synchronized (monitor()) {
                ...
                if (target == null) {
                    target = (org.apache.xmlbeans.SimpleValue) get_store()
                                                                   .add_element_user(PASSENGERLASTNAME$0);
                }
         ...
         */
        public void xsetPassengerLastName(
            org.apache.xmlbeans.XmlString passengerLastName) {
            synchronized (monitor()) {
                check_orphaned();
