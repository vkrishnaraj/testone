 ...
 */
public class LoadClaimResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.onlineclaims.LoadClaimResponseDocument {
    private static final javax.xml.namespace.QName LOADCLAIMRESPONSE$0 = new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com",
            "loadClaimResponse");
    ...
    public com.bagnet.nettracer.ws.onlineclaims.LoadClaimResponseDocument.LoadClaimResponse getLoadClaimResponse() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.onlineclaims.LoadClaimResponseDocument.LoadClaimResponse target =
                null;
            target = (com.bagnet.nettracer.ws.onlineclaims.LoadClaimResponseDocument.LoadClaimResponse) get_store()
                                                                                                            .find_element_user(LOADCLAIMRESPONSE$0,
                    0);
     ...
     */
    public void setLoadClaimResponse(
        com.bagnet.nettracer.ws.onlineclaims.LoadClaimResponseDocument.LoadClaimResponse loadClaimResponse) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.onlineclaims.LoadClaimResponseDocument.LoadClaimResponse) get_store()
                                                                                                                .add_element_user(LOADCLAIMRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class LoadClaimResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.onlineclaims.LoadClaimResponseDocument.LoadClaimResponse {
        ...
        public void setReturn(
            com.bagnet.nettracer.ws.onlineclaims.xsd.Claim xreturn) {
            synchronized (monitor()) {
                check_orphaned();
