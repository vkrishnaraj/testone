 ...
 */
public class UploadFileResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.onlineclaims.UploadFileResponseDocument {
    private static final javax.xml.namespace.QName UPLOADFILERESPONSE$0 = new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com",
            "uploadFileResponse");
    ...
    public com.bagnet.nettracer.ws.onlineclaims.UploadFileResponseDocument.UploadFileResponse getUploadFileResponse() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.onlineclaims.UploadFileResponseDocument.UploadFileResponse target =
                null;
            target = (com.bagnet.nettracer.ws.onlineclaims.UploadFileResponseDocument.UploadFileResponse) get_store()
                                                                                                              .find_element_user(UPLOADFILERESPONSE$0,
                    0);
     ...
     */
    public void setUploadFileResponse(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.onlineclaims.UploadFileResponseDocument.UploadFileResponse) get_store()
                                                                                                                  .add_element_user(UPLOADFILERESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class UploadFileResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.onlineclaims.UploadFileResponseDocument.UploadFileResponse {
        ...
        public com.bagnet.nettracer.ws.onlineclaims.xsd.File getReturn() {
            synchronized (monitor()) {
                ...
                target = (com.bagnet.nettracer.ws.onlineclaims.xsd.File) get_store()
        ...
        public void setReturn(
            com.bagnet.nettracer.ws.onlineclaims.xsd.File xreturn) {
            synchronized (monitor()) {
                check_orphaned();
