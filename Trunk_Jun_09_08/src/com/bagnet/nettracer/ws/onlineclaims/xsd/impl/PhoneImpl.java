...
public class PhoneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.onlineclaims.xsd.Phone
{
    ...
    private static final javax.xml.namespace.QName PHONENUMBER$0 = 
        new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com/xsd", "phoneNumber");
    private static final javax.xml.namespace.QName PHONETYPE$2 = 
        new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com/xsd", "phoneType");
    ...
    public org.apache.xmlbeans.XmlString xgetPhoneType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(PHONETYPE$2, 0);
            return target;
        }
    }
    ...
    public void xsetPhoneType(org.apache.xmlbeans.XmlString phoneType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(PHONETYPE$2);
            }
