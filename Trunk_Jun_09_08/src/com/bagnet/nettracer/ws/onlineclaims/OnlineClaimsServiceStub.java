    ...
    private void populateAxisService() throws org.apache.axis2.AxisFault {
     ...
     addAnonymousOperations();
	    ...
	    _service.addOperation(__operation);
            ...
            __operation.setName(new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com", "uploadFile"));
	    _service.addOperation(__operation);
            ...
            __operation.setName(new javax.xml.namespace.QName("http://onlineclaims.ws.nettracer.bagnet.com", "deleteFile"));
	    _service.addOperation(__operation);
          ...
          _operations[1].setMessageReceiver(
           ...
           _operationClient.execute(false);
                     ...
                     */
                            ...
                            com.bagnet.nettracer.ws.onlineclaims.AuthAdminUserDocument authAdminUser76)
          ...
          _operations[2].setMessageReceiver(
           ...
           _operationClient.execute(false);
                     ...
                     */
                            ...
                            com.bagnet.nettracer.ws.onlineclaims.UploadFileDocument uploadFile78)
                        ...
                        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                            ...
                            try {
                                org.apache.axiom.soap.SOAPEnvelope resultEnv = resultContext.getEnvelope();
                                        ...
                                        (com.bagnet.nettracer.ws.onlineclaims.UploadFileResponseDocument)object);
          ...
          _operations[3].setMessageReceiver(
           ...
           _operationClient.execute(false);
                     ...
                     */
                            ...
                            com.bagnet.nettracer.ws.onlineclaims.DeleteFileDocument deleteFile80)
                        ...
                        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                            ...
                            try {
                                org.apache.axiom.soap.SOAPEnvelope resultEnv = resultContext.getEnvelope();
                                        ...
                                        java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(),
                                                                         com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument.class,
                                                                         getEnvelopeNamespaces(resultEnv));
                                        callback.receiveResultdeleteFile(
                                        (com.bagnet.nettracer.ws.onlineclaims.DeleteFileResponseDocument)object);
									...
									if (faultElt!=null){
										if (faultExceptionNameMap.containsKey(faultElt.getQName())){
											...
											try{
										            ...
										            callback.receiveErrordeleteFile(new java.rmi.RemoteException(ex.getMessage(), ex));
                                            } catch(java.lang.ClassCastException e){
                                                // we cannot intantiate the class - throw the original Axis fault
                            ...
                            public void onComplete() {
                                try {
                                    ...
                                    callback.receiveErrordeleteFile(axisFault);
                                }
                            }
                });
          ...
          _operations[4].setMessageReceiver(
           ...
           _operationClient.execute(false);
                     ...
                     */
                            ...
                            com.bagnet.nettracer.ws.onlineclaims.AuthPassengerDocument authPassenger82)
            ...
            private org.apache.axiom.om.OMElement toOM(final com.bagnet.nettracer.ws.onlineclaims.AuthPassengerResponseDocument param)
                ...
                return  new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(xmlReader.getName(),
                        ...
                        omDataSource);
                                ...
                                private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.onlineclaims.UploadFileDocument param, boolean optimizeContent)
                                throws org.apache.axis2.AxisFault{
                                org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                                if (param != null){
                                envelope.getBody().addChild(toOM(param, optimizeContent));
                                ...
                                private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.onlineclaims.DeleteFileDocument param, boolean optimizeContent)
                                throws org.apache.axis2.AxisFault{
                                org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                                if (param != null){
                                envelope.getBody().addChild(toOM(param, optimizeContent));
