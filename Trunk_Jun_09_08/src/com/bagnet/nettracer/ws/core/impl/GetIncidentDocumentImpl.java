 ...
 */
public class GetIncidentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.core.GetIncidentDocument {
    private static final javax.xml.namespace.QName GETINCIDENT$0 = new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com",
            "getIncident");
    ...
    public com.bagnet.nettracer.ws.core.GetIncidentDocument.GetIncident getGetIncident() {
        synchronized (monitor()) {
            ...
            target = (com.bagnet.nettracer.ws.core.GetIncidentDocument.GetIncident) get_store()
                                                                                        .find_element_user(GETINCIDENT$0,
                    0);
    ...
    public void setGetIncident(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.core.GetIncidentDocument.GetIncident) get_store()
                                                                                            .add_element_user(GETINCIDENT$0);
            }
