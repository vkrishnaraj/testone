 ...
 */
public class InsertQuickOHDResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument
{
    
    public InsertQuickOHDResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName INSERTQUICKOHDRESPONSE$0 = 
        new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com", "insertQuickOHDResponse");
    ...
    public com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument.InsertQuickOHDResponse getInsertQuickOHDResponse()
    {
        ...
        {
            check_orphaned();
            com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument.InsertQuickOHDResponse target = null;
            target = (com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument.InsertQuickOHDResponse)get_store().find_element_user(INSERTQUICKOHDRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setInsertQuickOHDResponse(com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument.InsertQuickOHDResponse insertQuickOHDResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument.InsertQuickOHDResponse)get_store().add_element_user(INSERTQUICKOHDRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class InsertQuickOHDResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument.InsertQuickOHDResponse
    {
