 ...
 */
public class BeornOHDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.BeornOHDDocument
{
    ...
    private static final javax.xml.namespace.QName BEORNOHD$0 = 
        new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com", "beornOHD");
    ...
    public com.bagnet.nettracer.ws.core.BeornOHDDocument.BeornOHD getBeornOHD()
    {
        synchronized (monitor())
        {
            ...
            target = (com.bagnet.nettracer.ws.core.BeornOHDDocument.BeornOHD)get_store().find_element_user(BEORNOHD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setBeornOHD(com.bagnet.nettracer.ws.core.BeornOHDDocument.BeornOHD beornOHD)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.bagnet.nettracer.ws.core.BeornOHDDocument.BeornOHD)get_store().add_element_user(BEORNOHD$0);
            }
            target.set(beornOHD);
        }
    }
     ...
     * This is a complex type.
     */
    public static class BeornOHDImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.BeornOHDDocument.BeornOHD
    {
        ...
        public com.bagnet.nettracer.ws.core.pojo.xsd.WSBEORN getSi()
        {
            synchronized (monitor())
            {
                ...
                target = (com.bagnet.nettracer.ws.core.pojo.xsd.WSBEORN)get_store().find_element_user(SI$2, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public void setSi(com.bagnet.nettracer.ws.core.pojo.xsd.WSBEORN si)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (com.bagnet.nettracer.ws.core.pojo.xsd.WSBEORN)get_store().add_element_user(SI$2);
                }
                target.set(si);
            }
        }
