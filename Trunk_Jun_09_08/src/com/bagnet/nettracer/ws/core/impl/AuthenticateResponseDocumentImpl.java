 ...
 */
public class AuthenticateResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.AuthenticateResponseDocument
{
    ...
    private static final javax.xml.namespace.QName AUTHENTICATERESPONSE$0 = 
        new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com", "authenticateResponse");
    ...
    public com.bagnet.nettracer.ws.core.AuthenticateResponseDocument.AuthenticateResponse getAuthenticateResponse()
    {
        ...
        {
            check_orphaned();
            com.bagnet.nettracer.ws.core.AuthenticateResponseDocument.AuthenticateResponse target = null;
            target = (com.bagnet.nettracer.ws.core.AuthenticateResponseDocument.AuthenticateResponse)get_store().find_element_user(AUTHENTICATERESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAuthenticateResponse(com.bagnet.nettracer.ws.core.AuthenticateResponseDocument.AuthenticateResponse authenticateResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.bagnet.nettracer.ws.core.AuthenticateResponseDocument.AuthenticateResponse)get_store().add_element_user(AUTHENTICATERESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class AuthenticateResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.AuthenticateResponseDocument.AuthenticateResponse
    {
