 ...
 */
public class InsertIncidentResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument {
    private static final javax.xml.namespace.QName INSERTINCIDENTRESPONSE$0 = new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com",
            "insertIncidentResponse");

    public InsertIncidentResponseDocumentImpl(
    ...
    public com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument.InsertIncidentResponse getInsertIncidentResponse() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument.InsertIncidentResponse target =
                null;
            target = (com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument.InsertIncidentResponse) get_store()
                                                                                                              .find_element_user(INSERTINCIDENTRESPONSE$0,
                    0);
     ...
     */
    public void setInsertIncidentResponse(
        com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument.InsertIncidentResponse insertIncidentResponse) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument.InsertIncidentResponse) get_store()
                                                                                                                  .add_element_user(INSERTINCIDENTRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class InsertIncidentResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument.InsertIncidentResponse {
