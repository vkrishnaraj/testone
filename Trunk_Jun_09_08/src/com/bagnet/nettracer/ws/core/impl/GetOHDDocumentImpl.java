 ...
 */
public class GetOHDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.GetOHDDocument
{
    ...
    private static final javax.xml.namespace.QName GETOHD$0 = 
        new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com", "getOHD");
    ...
    public com.bagnet.nettracer.ws.core.GetOHDDocument.GetOHD getGetOHD()
    {
        synchronized (monitor())
        {
            ...
            target = (com.bagnet.nettracer.ws.core.GetOHDDocument.GetOHD)get_store().find_element_user(GETOHD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetOHD(com.bagnet.nettracer.ws.core.GetOHDDocument.GetOHD getOHD)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.bagnet.nettracer.ws.core.GetOHDDocument.GetOHD)get_store().add_element_user(GETOHD$0);
            }
            target.set(getOHD);
        }
    }
     ...
     * This is a complex type.
     */
    public static class GetOHDImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.GetOHDDocument.GetOHD
    {
        ...
        private static final javax.xml.namespace.QName OHDID$2 = 
            new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com", "ohd_id");
