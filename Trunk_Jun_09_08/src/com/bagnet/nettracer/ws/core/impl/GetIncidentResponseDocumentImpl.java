 ...
 */
public class GetIncidentResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.core.GetIncidentResponseDocument {
    private static final javax.xml.namespace.QName GETINCIDENTRESPONSE$0 = new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com",
            "getIncidentResponse");
    ...
    public com.bagnet.nettracer.ws.core.GetIncidentResponseDocument.GetIncidentResponse getGetIncidentResponse() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.core.GetIncidentResponseDocument.GetIncidentResponse target =
                null;
            target = (com.bagnet.nettracer.ws.core.GetIncidentResponseDocument.GetIncidentResponse) get_store()
                                                                                                        .find_element_user(GETINCIDENTRESPONSE$0,
                    0);
     ...
     */
    public void setGetIncidentResponse(
        com.bagnet.nettracer.ws.core.GetIncidentResponseDocument.GetIncidentResponse getIncidentResponse) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.core.GetIncidentResponseDocument.GetIncidentResponse) get_store()
                                                                                                            .add_element_user(GETINCIDENTRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class GetIncidentResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.core.GetIncidentResponseDocument.GetIncidentResponse {
        ...
        public void setReturn(
            com.bagnet.nettracer.ws.core.pojo.xsd.WSIncident xreturn) {
            synchronized (monitor()) {
                check_orphaned();
