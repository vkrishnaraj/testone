 ...
 */
public class UpdateBdoDeliveryResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument {
    private static final javax.xml.namespace.QName UPDATEBDODELIVERYRESPONSE$0 = new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com",
            "UpdateBdoDeliveryResponse");

    public UpdateBdoDeliveryResponseDocumentImpl(
    ...
    public com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument.UpdateBdoDeliveryResponse getUpdateBdoDeliveryResponse() {
        synchronized (monitor()) {
            ...
            com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument.UpdateBdoDeliveryResponse target =
                null;
            target = (com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument.UpdateBdoDeliveryResponse) get_store()
                                                                                                                    .find_element_user(UPDATEBDODELIVERYRESPONSE$0,
                    0);
     ...
     */
    public void setUpdateBdoDeliveryResponse(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument.UpdateBdoDeliveryResponse) get_store()
                                                                                                                        .add_element_user(UPDATEBDODELIVERYRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class UpdateBdoDeliveryResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument.UpdateBdoDeliveryResponse {
        private static final javax.xml.namespace.QName RETURN$0 = new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com",
                "return");

        public UpdateBdoDeliveryResponseImpl(
            org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
