 ...
 */
public class LogoffDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.LogoffDocument
{
    ...
    private static final javax.xml.namespace.QName LOGOFF$0 = 
        new javax.xml.namespace.QName("http://core.ws.nettracer.bagnet.com", "logoff");
    ...
    public com.bagnet.nettracer.ws.core.LogoffDocument.Logoff getLogoff()
    {
        synchronized (monitor())
        {
            ...
            target = (com.bagnet.nettracer.ws.core.LogoffDocument.Logoff)get_store().find_element_user(LOGOFF$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLogoff(com.bagnet.nettracer.ws.core.LogoffDocument.Logoff logoff)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.bagnet.nettracer.ws.core.LogoffDocument.Logoff)get_store().add_element_user(LOGOFF$0);
            }
            target.set(logoff);
        }
    }
     ...
     * This is a complex type.
     */
    public static class LogoffImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.LogoffDocument.Logoff
    {
