 ...
 */
public class BdoStatusUpdateImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.pojo.xsd.BdoStatusUpdate
{
    ...
    private static final javax.xml.namespace.QName BDO$0 = 
        new javax.xml.namespace.QName("http://pojo.core.ws.nettracer.bagnet.com/xsd", "bdo");
    private static final javax.xml.namespace.QName REMARKS$2 = 
        new javax.xml.namespace.QName("http://pojo.core.ws.nettracer.bagnet.com/xsd", "remarks");
    ...
    private static final javax.xml.namespace.QName STATUSDATETIME$6 = 
        new javax.xml.namespace.QName("http://pojo.core.ws.nettracer.bagnet.com/xsd", "statusDateTime");
    ...
    public int getBdo()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(BDO$0, 0);
            if (target == null)
            {
                return 0;
            }
    ...
    public org.apache.xmlbeans.XmlInt xgetBdo()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlInt)get_store().find_element_user(BDO$0, 0);
            return target;
        }
    }
    ...
    public void setBdo(int bdo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(BDO$0);
            }
    ...
    public void xsetBdo(org.apache.xmlbeans.XmlInt bdo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInt)get_store().add_element_user(BDO$0);
            }
            target.set(bdo);
        }
    }
    ...
    public java.lang.String getRemarks()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(REMARKS$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetRemarks()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(REMARKS$2, 0);
            return target;
        }
    }
    ...
    public void setRemarks(java.lang.String remarks)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(REMARKS$2);
            }
    ...
    public void xsetRemarks(org.apache.xmlbeans.XmlString remarks)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(REMARKS$2);
            }
            target.set(remarks);
        }
    }
    ...
    public java.util.Calendar getStatusDateTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(STATUSDATETIME$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlDateTime xgetStatusDateTime()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlDateTime)get_store().find_element_user(STATUSDATETIME$6, 0);
            return target;
        }
    }
    ...
    public void setStatusDateTime(java.util.Calendar statusDateTime)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(STATUSDATETIME$6);
            }
     ...
     */
    public void xsetStatusDateTime(org.apache.xmlbeans.XmlDateTime statusDateTime)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlDateTime)get_store().add_element_user(STATUSDATETIME$6);
            }
