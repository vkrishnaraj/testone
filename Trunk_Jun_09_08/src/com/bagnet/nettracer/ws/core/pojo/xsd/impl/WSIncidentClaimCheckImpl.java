 ...
 */
public class WSIncidentClaimCheckImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.bagnet.nettracer.ws.core.pojo.xsd.WSIncidentClaimCheck
{
    ...
    private static final javax.xml.namespace.QName CLAIMCHECKNUM$0 = 
        new javax.xml.namespace.QName("http://pojo.core.ws.nettracer.bagnet.com/xsd", "claimchecknum");
    private static final javax.xml.namespace.QName MATCHEDOHD$2 = 
    ...
    public java.lang.String getClaimchecknum()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(CLAIMCHECKNUM$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetClaimchecknum()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(CLAIMCHECKNUM$0, 0);
            return target;
        }
    }
    ...
    public void setClaimchecknum(java.lang.String claimchecknum)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(CLAIMCHECKNUM$0);
            }
    ...
    public void xsetClaimchecknum(org.apache.xmlbeans.XmlString claimchecknum)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(CLAIMCHECKNUM$0);
            }
    ...
    public java.lang.String getMatchedOhd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(MATCHEDOHD$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetMatchedOhd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(MATCHEDOHD$2, 0);
            return target;
        }
    }
    ...
    public void setMatchedOhd(java.lang.String matchedOhd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(MATCHEDOHD$2);
            }
    ...
    public void xsetMatchedOhd(org.apache.xmlbeans.XmlString matchedOhd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(MATCHEDOHD$2);
            }
