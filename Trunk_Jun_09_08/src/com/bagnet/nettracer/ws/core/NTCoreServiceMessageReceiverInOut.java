 ...
 */
        ...
        */
        ...
        public class NTCoreServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("authenticate".equals(methodName)){
                ...
                com.bagnet.nettracer.ws.core.AuthenticateResponseDocument authenticateResponse1 = null;
	                        com.bagnet.nettracer.ws.core.AuthenticateDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.AuthenticateDocument)fromOM(
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), authenticateResponse1, false);
                                    } else 

            if("beornOHD".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.BeornOHDResponseDocument beornOHDResponse3 = null;
	                        com.bagnet.nettracer.ws.core.BeornOHDDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.BeornOHDDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               beornOHDResponse3 =
                                                         ...
                                                         skel.beornOHD(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), beornOHDResponse3, false);
                                    } else 

            if("getOHD".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.GetOHDResponseDocument getOHDResponse5 = null;
	                        com.bagnet.nettracer.ws.core.GetOHDDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.GetOHDDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getOHDResponse5, false);
                                    } else 

            if("insertIncident".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument insertIncidentResponse7 = null;
	                        com.bagnet.nettracer.ws.core.InsertIncidentDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.InsertIncidentDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    com.bagnet.nettracer.ws.core.InsertIncidentDocument.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               insertIncidentResponse7 =
                                                   
                                                   
                                                         skel.insertIncident(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), insertIncidentResponse7, false);
                                    } else 

            if("insertOHD".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.InsertOHDResponseDocument insertOHDResponse9 = null;
	                        com.bagnet.nettracer.ws.core.InsertOHDDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.InsertOHDDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               insertOHDResponse9 =
                                                         ...
                                                         skel.insertOHD(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), insertOHDResponse9, false);
                                    } else 

            if("updateBdoDelivery".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument updateBdoDeliveryResponse11 = null;
	                        com.bagnet.nettracer.ws.core.UpdateBdoDeliveryDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.UpdateBdoDeliveryDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    com.bagnet.nettracer.ws.core.UpdateBdoDeliveryDocument.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               updateBdoDeliveryResponse11 =
                                                   
                                                   
                                                         skel.updateBdoDelivery(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), updateBdoDeliveryResponse11, false);
                                    } else 

            if("getIncident".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.GetIncidentResponseDocument getIncidentResponse13 = null;
	                        com.bagnet.nettracer.ws.core.GetIncidentDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.GetIncidentDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    com.bagnet.nettracer.ws.core.GetIncidentDocument.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getIncidentResponse13 =
                                                   
                                                   
                                                         skel.getIncident(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getIncidentResponse13, false);
                                    } else 

            if("queryForFaultCode".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.QueryForFaultCodeResponseDocument queryForFaultCodeResponse15 = null;
	                        com.bagnet.nettracer.ws.core.QueryForFaultCodeDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.QueryForFaultCodeDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    com.bagnet.nettracer.ws.core.QueryForFaultCodeDocument.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               queryForFaultCodeResponse15 =
                                                   
                                                   
                                                         skel.queryForFaultCode(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), queryForFaultCodeResponse15, false);
                                    } else 

            if("logoff".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.LogoffResponseDocument logoffResponse17 = null;
	                        com.bagnet.nettracer.ws.core.LogoffDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.LogoffDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               logoffResponse17 =
                                                         ...
                                                         skel.logoff(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), logoffResponse17, false);
                                    } else 

            if("updateIncidentFaultCodes".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.UpdateIncidentFaultCodesResponseDocument updateIncidentFaultCodesResponse19 = null;
	                        com.bagnet.nettracer.ws.core.UpdateIncidentFaultCodesDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.UpdateIncidentFaultCodesDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    com.bagnet.nettracer.ws.core.UpdateIncidentFaultCodesDocument.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               updateIncidentFaultCodesResponse19 =
                                                   
                                                   
                                                         skel.updateIncidentFaultCodes(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), updateIncidentFaultCodesResponse19, false);
                                    } else 

            if("insertQuickOHD".equals(methodName)){
                
                com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument insertQuickOHDResponse21 = null;
	                        com.bagnet.nettracer.ws.core.InsertQuickOHDDocument wrappedParam =
                                                             (com.bagnet.nettracer.ws.core.InsertQuickOHDDocument)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    com.bagnet.nettracer.ws.core.InsertQuickOHDDocument.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               insertQuickOHDResponse21 =
                                                   
                                                   
                                                         skel.insertQuickOHD(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), insertQuickOHDResponse21, false);
            ...
            private org.apache.axiom.om.OMElement toOM(final com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument param)
                ...
                return  new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(xmlReader.getName(),
                        ...
                        omDataSource);
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.AuthenticateResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.BeornOHDResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.GetOHDResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.InsertIncidentResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.InsertOHDResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.GetIncidentResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.QueryForFaultCodeResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.LogoffResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.UpdateIncidentFaultCodesResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
                            ...
                            private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.bagnet.nettracer.ws.core.InsertQuickOHDResponseDocument param, boolean optimizeContent)
                            throws org.apache.axis2.AxisFault {
                            org.apache.axiom.soap.SOAPEnvelope envelope = factory.getDefaultEnvelope();
                            if (param != null){
                            envelope.getBody().addChild(toOM(param, optimizeContent));
