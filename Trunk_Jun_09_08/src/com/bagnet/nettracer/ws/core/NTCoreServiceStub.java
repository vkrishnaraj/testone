                ...
                public void onMessage(
                    ...
                    try {
                        ...
                        java.lang.Object object = fromOM(resultEnv.getBody()
                                ...
                                com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument.class,
                                getEnvelopeNamespaces(resultEnv));
                        callback.receiveResultUpdateBdoDelivery((com.bagnet.nettracer.ws.core.UpdateBdoDeliveryResponseDocument) object);
                    } catch (org.apache.axis2.AxisFault e) {
                        ...
                        if (faultElt != null) {
                            if (faultExceptionNameMap.containsKey(
                                ...
                                try {
                                    ...
                                    callback.receiveErrorUpdateBdoDelivery(new java.rmi.RemoteException(
                                            ex.getMessage(), ex));
                                } catch (java.lang.ClassCastException e) {
                                    // we cannot intantiate the class - throw the original Axis fault
