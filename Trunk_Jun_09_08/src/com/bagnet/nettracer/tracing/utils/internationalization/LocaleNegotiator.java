...
package com.bagnet.nettracer.tracing.utils.internationalization;
...
import com.bagnet.nettracer.tracing.utils.internationalization.LocaleToCharsetMap;
...
public class LocaleNegotiator {
   ...
   */
  public LocaleNegotiator(HttpServletRequest request) {
    ...
    String bundleName = "com.bagnet.nettracer.tracing.resources.ApplicationResources";
