...
public class WorldTracerAFAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (wt_type == null || wt_type.equals("") || wt_type.equals("null")) wt_type = "FW";
		String day = request.getParameter("d");
		if (day == null || day.equals("") || day.equals("null")) day = "1";
		...
		/** ************ pagination ************* */
		int rowsperpage = request.getParameter("rowsperpage") != null ? Integer.parseInt(request.getParameter("rowsperpage")) : TracingConstants.ROWS_PER_PAGE;
