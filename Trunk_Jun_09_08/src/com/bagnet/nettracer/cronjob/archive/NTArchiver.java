...
public class NTArchiver {
	...
	private static Logger logger = Logger.getLogger(NTArchiver.class);
	...
	public static void main(String args[]) {
		...
		try {
			...
			NTArchiver archiver = new NTArchiver(cfg.getProperties());
	...
	public NTArchiver(Properties properties) {
