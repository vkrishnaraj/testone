...
public class WorldTracerQueueWorker implements Runnable {
	...
	public WorldTracerQueueWorker(WorldTracerService service, WTQueueBmo qBmo, Agent defAgent, WT_ActionFileBmo afBmo,
			ConcurrentLinkedQueue<WorldTracerQueue> qq) {
