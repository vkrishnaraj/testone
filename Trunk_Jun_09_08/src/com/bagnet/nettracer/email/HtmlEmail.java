 ...
 * 
 * <p>
 * This class also inherits from MultiPartEmail, so it is easy to add attachents
 * to the email.
 * 
 * <p>
 ...
 * method. The alternate text content can be set with setTextMsg.
 * 
 * <p>
...
public class HtmlEmail extends MultiPartEmail {
	 ...
	 *           see javax.mail.internet.MimeBodyPart for defintions
	 */
	 ...
	 * message is formatted in HTML for the HTML part of the message, it is let as
	 * is in the alternate text part.
	 * 
	 * @param msg
	 *          A String.
	 * @return An Email.
	...
	public Email setMsg(String msg) throws EmailException {
		...
		setHtmlMsg(new StringBuffer().append("<html><body><pre>").append(msg).append(
	 ...
	 * 
	 * <p>
	 * This method allows to embed a file located by an URL into the mail body. It
	 * allows, for instance, to add inline images to the email. Inline files may
	 * be referenced with a <code>cid:xxxxxx</code> URL, where xxxxxx is the
	 ...
	 * @throws MessagingException
	 *           when URL suplpied is invalid also see
	 *           javax.mail.internet.MimeBodyPart for defintions
	 */
