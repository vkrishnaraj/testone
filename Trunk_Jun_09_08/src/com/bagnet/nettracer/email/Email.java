...
public abstract class Email {
	...
	/**
	 * Sets the userName and password if authentication is needed. If this method
	 * is not used, no authentication will be performed.
	 * <p>
	...
	public void setSmtpPort(int aPortNumber) {
		if (aPortNumber < 1) {
			throw new IllegalArgumentException("Cannot connect to a port number that is less than 1 ( "
					+ aPortNumber + " )");
		}
	 ...
	 * @throws EmailException
	 */
	private InternetAddress createInternetAddress(String email, String name) throws EmailException {
