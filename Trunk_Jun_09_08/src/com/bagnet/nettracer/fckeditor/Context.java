...
public class Context {
	...
	private String ckEditorFuncNumStr;
	...
	protected Context(final HttpServletRequest request) {
		...
		ckEditorFuncNumStr = request.getParameter("CKEditorFuncNum");
	...
	/**
	 * Returns the CKEditorFuncNum parameter of this context.
	 * 
	 * @return the CKEditorFuncNum parameter of this context
	 */
	public String getCkEditorFuncNumStr() {
		return ckEditorFuncNumStr;
	}
	...
	public void logBaseParameters() {
		...
		logger.debug("Parameter CKEditorFuncNum: {}", ckEditorFuncNumStr);
	}
