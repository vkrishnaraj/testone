...
//			WTStatus status = WTStatus.valueOf(req.getParameter("status"));
//			String daterange=req.getParameter("dt");
//			
//			if (status == null) status = WTStatus.ACTIVE;
...
//		
//		// retrieve all raf
//		String result = WorldTracerUtils.getAllRAF(client, airline, station, WTStatus.ACTIVE,"");
//		
//	
//		System.out.println("###\n" + result + "\n###");
	}
