		...
		try {
			...
			SQLQuery query = sess.createSQLQuery("select longitude, latitude "
					...
					+ (useFIPs ? "countyfp in " + zip + " " : "(zipl = '" + zip
							+ "' or zipr = '" + zip + "') ")
					+ (useNumber ? "and (((rfromadd2 <= " + parsed.getNum()
							+ " and rtoadd2 >= " + parsed.getNum()
							+ ") or (lfromadd2 <= " + parsed.getNum()
							+ " and ltoadd2 >= " + parsed.getNum()
							+ ")) or ((rtoadd2 <= " + parsed.getNum()
							+ " and rfromadd2 >= " + parsed.getNum()
							+ ") or (ltoadd2 <= " + parsed.getNum()
							+ " and lfromadd2 >= " + parsed.getNum() + ")))"
							: ""));
