 ...
 */
public class GetOsiContentsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements aero.nettracer.serviceprovider.ws_1_0.GetOsiContentsDocument {
    private static final javax.xml.namespace.QName GETOSICONTENTS$0 = new javax.xml.namespace.QName("http://ws_1_0.serviceprovider.nettracer.aero",
            "getOsiContents");

    public GetOsiContentsDocumentImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType);
    }
     ...
     */
    public aero.nettracer.serviceprovider.ws_1_0.GetOsiContentsDocument.GetOsiContents getGetOsiContents() {
        synchronized (monitor()) {
            check_orphaned();

            aero.nettracer.serviceprovider.ws_1_0.GetOsiContentsDocument.GetOsiContents target =
                null;
            target = (aero.nettracer.serviceprovider.ws_1_0.GetOsiContentsDocument.GetOsiContents) get_store()
                                                                                                       .find_element_user(GETOSICONTENTS$0,
                    0);
    ...
    public void setGetOsiContents(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (aero.nettracer.serviceprovider.ws_1_0.GetOsiContentsDocument.GetOsiContents) get_store()
                                                                                                           .add_element_user(GETOSICONTENTS$0);
            }

            target.set(getOsiContents);
        }
    }
     ...
     */
    public aero.nettracer.serviceprovider.ws_1_0.GetOsiContentsDocument.GetOsiContents addNewGetOsiContents() {
        synchronized (monitor()) {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class GetOsiContentsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements aero.nettracer.serviceprovider.ws_1_0.GetOsiContentsDocument.GetOsiContents {
        ...
        public GetOsiContentsImpl(org.apache.xmlbeans.SchemaType sType) {
            super(sType);
        }
