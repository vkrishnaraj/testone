 ...
 */
public class RequestHeaderImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements aero.nettracer.serviceprovider.ws_1_0.common.xsd.RequestHeader {
    private static final javax.xml.namespace.QName PARAMETERS$0 = new javax.xml.namespace.QName("http://common.ws_1_0.serviceprovider.nettracer.aero/xsd",
            "parameters");
    private static final javax.xml.namespace.QName PASSWORD$2 = new javax.xml.namespace.QName("http://common.ws_1_0.serviceprovider.nettracer.aero/xsd",
            "password");
    private static final javax.xml.namespace.QName USERNAME$4 = new javax.xml.namespace.QName("http://common.ws_1_0.serviceprovider.nettracer.aero/xsd",
            "username");
     ...
     */
    public aero.nettracer.serviceprovider.ws_1_0.common.xsd.Parameter getParameters() {
        synchronized (monitor()) {
            check_orphaned();

            aero.nettracer.serviceprovider.ws_1_0.common.xsd.Parameter target = null;
            target = (aero.nettracer.serviceprovider.ws_1_0.common.xsd.Parameter) get_store()
                                                                                      .find_element_user(PARAMETERS$0,
                    0);
