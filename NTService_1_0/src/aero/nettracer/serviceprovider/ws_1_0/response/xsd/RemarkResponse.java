/*
 * XML Type:  RemarkResponse
 * Namespace: http://response.ws_1_0.serviceprovider.nettracer.aero/xsd
 * Java type: aero.nettracer.serviceprovider.ws_1_0.response.xsd.RemarkResponse
 *
...
/**
 * An XML RemarkResponse(@http://response.ws_1_0.serviceprovider.nettracer.aero/xsd).
 *
...
public interface RemarkResponse extends aero.nettracer.serviceprovider.ws_1_0.response.xsd.GenericResponse {
    ...
    public static final class Factory {
        ...
        public static aero.nettracer.serviceprovider.ws_1_0.response.xsd.RemarkResponse newInstance() {
            return (aero.nettracer.serviceprovider.ws_1_0.response.xsd.RemarkResponse) org.apache.xmlbeans.XmlBeans.getContextTypeLoader()
                                                                                                                   .newInstance(type,
                null);
        }
        ...
        public static aero.nettracer.serviceprovider.ws_1_0.response.xsd.RemarkResponse parse(
