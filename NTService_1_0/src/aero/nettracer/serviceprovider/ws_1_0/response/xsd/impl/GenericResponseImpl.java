 ...
 */
public class GenericResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.ws_1_0.response.xsd.GenericResponse
{
    ...
    private static final javax.xml.namespace.QName ERROR$0 = 
        new javax.xml.namespace.QName("http://response.ws_1_0.serviceprovider.nettracer.aero/xsd", "error");
    ...
    public aero.nettracer.serviceprovider.ws_1_0.common.xsd.WebServiceError getError()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.ws_1_0.common.xsd.WebServiceError target = null;
            target = (aero.nettracer.serviceprovider.ws_1_0.common.xsd.WebServiceError)get_store().find_element_user(ERROR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setError(aero.nettracer.serviceprovider.ws_1_0.common.xsd.WebServiceError error)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.ws_1_0.common.xsd.WebServiceError)get_store().add_element_user(ERROR$0);
            }
            target.set(error);
        }
    }
