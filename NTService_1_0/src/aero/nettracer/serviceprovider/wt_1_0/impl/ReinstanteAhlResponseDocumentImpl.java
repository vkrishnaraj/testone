 ...
 */
public class ReinstanteAhlResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlResponseDocument
{
    
    public ReinstanteAhlResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName REINSTANTEAHLRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "reinstanteAhlResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlResponseDocument.ReinstanteAhlResponse getReinstanteAhlResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlResponseDocument.ReinstanteAhlResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlResponseDocument.ReinstanteAhlResponse)get_store().find_element_user(REINSTANTEAHLRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setReinstanteAhlResponse(aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlResponseDocument.ReinstanteAhlResponse reinstanteAhlResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlResponseDocument.ReinstanteAhlResponse)get_store().add_element_user(REINSTANTEAHLRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class ReinstanteAhlResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlResponseDocument.ReinstanteAhlResponse
    {
