 ...
 */
public class GetActionFileSummaryResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetActionFileSummaryResponseDocument
{
    
    public GetActionFileSummaryResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETACTIONFILESUMMARYRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "getActionFileSummaryResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.GetActionFileSummaryResponseDocument.GetActionFileSummaryResponse getGetActionFileSummaryResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.GetActionFileSummaryResponseDocument.GetActionFileSummaryResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.GetActionFileSummaryResponseDocument.GetActionFileSummaryResponse)get_store().find_element_user(GETACTIONFILESUMMARYRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetActionFileSummaryResponse(aero.nettracer.serviceprovider.wt_1_0.GetActionFileSummaryResponseDocument.GetActionFileSummaryResponse getActionFileSummaryResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.GetActionFileSummaryResponseDocument.GetActionFileSummaryResponse)get_store().add_element_user(GETACTIONFILESUMMARYRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class GetActionFileSummaryResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetActionFileSummaryResponseDocument.GetActionFileSummaryResponse
    {
        
        public GetActionFileSummaryResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
