 ...
 */
public class CreateBdoDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateBdoDocument
{
    ...
    private static final javax.xml.namespace.QName CREATEBDO$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "createBdo");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.CreateBdoDocument.CreateBdo getCreateBdo()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.CreateBdoDocument.CreateBdo target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.CreateBdoDocument.CreateBdo)get_store().find_element_user(CREATEBDO$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCreateBdo(aero.nettracer.serviceprovider.wt_1_0.CreateBdoDocument.CreateBdo createBdo)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.CreateBdoDocument.CreateBdo)get_store().add_element_user(CREATEBDO$0);
            }
     ...
     * This is a complex type.
     */
    public static class CreateBdoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateBdoDocument.CreateBdo
    {
        ...
        private static final javax.xml.namespace.QName BDO$2 = 
            new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "bdo");
        ...
        public aero.nettracer.serviceprovider.wt_1_0.common.xsd.Bdo getBdo()
        {
            synchronized (monitor())
            {
                ...
                target = (aero.nettracer.serviceprovider.wt_1_0.common.xsd.Bdo)get_store().find_element_user(BDO$2, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setBdo(aero.nettracer.serviceprovider.wt_1_0.common.xsd.Bdo bdo)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (aero.nettracer.serviceprovider.wt_1_0.common.xsd.Bdo)get_store().add_element_user(BDO$2);
                }
                target.set(bdo);
            }
        }
