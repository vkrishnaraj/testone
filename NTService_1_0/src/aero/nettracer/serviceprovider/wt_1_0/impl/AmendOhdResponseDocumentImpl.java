 ...
 */
public class AmendOhdResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.AmendOhdResponseDocument
{
    ...
    private static final javax.xml.namespace.QName AMENDOHDRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "amendOhdResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.AmendOhdResponseDocument.AmendOhdResponse getAmendOhdResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.AmendOhdResponseDocument.AmendOhdResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.AmendOhdResponseDocument.AmendOhdResponse)get_store().find_element_user(AMENDOHDRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAmendOhdResponse(aero.nettracer.serviceprovider.wt_1_0.AmendOhdResponseDocument.AmendOhdResponse amendOhdResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.AmendOhdResponseDocument.AmendOhdResponse)get_store().add_element_user(AMENDOHDRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class AmendOhdResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.AmendOhdResponseDocument.AmendOhdResponse
    {
