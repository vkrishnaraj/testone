 ...
 */
public class CloseAhlDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CloseAhlDocument
{
    ...
    private static final javax.xml.namespace.QName CLOSEAHL$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "closeAhl");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.CloseAhlDocument.CloseAhl getCloseAhl()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.CloseAhlDocument.CloseAhl target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.CloseAhlDocument.CloseAhl)get_store().find_element_user(CLOSEAHL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCloseAhl(aero.nettracer.serviceprovider.wt_1_0.CloseAhlDocument.CloseAhl closeAhl)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.CloseAhlDocument.CloseAhl)get_store().add_element_user(CLOSEAHL$0);
            }
            target.set(closeAhl);
        }
    }
     ...
     * This is a complex type.
     */
    public static class CloseAhlImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CloseAhlDocument.CloseAhl
    {
