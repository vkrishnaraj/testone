 ...
 */
public class GetActionFileDetailsResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsResponseDocument
{
    
    public GetActionFileDetailsResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETACTIONFILEDETAILSRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "getActionFileDetailsResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsResponseDocument.GetActionFileDetailsResponse getGetActionFileDetailsResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsResponseDocument.GetActionFileDetailsResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsResponseDocument.GetActionFileDetailsResponse)get_store().find_element_user(GETACTIONFILEDETAILSRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetActionFileDetailsResponse(aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsResponseDocument.GetActionFileDetailsResponse getActionFileDetailsResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsResponseDocument.GetActionFileDetailsResponse)get_store().add_element_user(GETACTIONFILEDETAILSRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class GetActionFileDetailsResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsResponseDocument.GetActionFileDetailsResponse
    {
        
        public GetActionFileDetailsResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
