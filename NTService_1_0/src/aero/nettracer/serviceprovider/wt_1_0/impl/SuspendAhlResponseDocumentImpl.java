 ...
 */
public class SuspendAhlResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.SuspendAhlResponseDocument
{
    ...
    private static final javax.xml.namespace.QName SUSPENDAHLRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "suspendAhlResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.SuspendAhlResponseDocument.SuspendAhlResponse getSuspendAhlResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.SuspendAhlResponseDocument.SuspendAhlResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.SuspendAhlResponseDocument.SuspendAhlResponse)get_store().find_element_user(SUSPENDAHLRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSuspendAhlResponse(aero.nettracer.serviceprovider.wt_1_0.SuspendAhlResponseDocument.SuspendAhlResponse suspendAhlResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.SuspendAhlResponseDocument.SuspendAhlResponse)get_store().add_element_user(SUSPENDAHLRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class SuspendAhlResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.SuspendAhlResponseDocument.SuspendAhlResponse
    {
