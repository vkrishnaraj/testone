 ...
 */
public class SendForwardMessageDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageDocument {
    private static final javax.xml.namespace.QName SENDFORWARDMESSAGE$0 = new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero",
            "sendForwardMessage");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageDocument.SendForwardMessage getSendForwardMessage() {
        synchronized (monitor()) {
            ...
            aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageDocument.SendForwardMessage target =
                null;
            target = (aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageDocument.SendForwardMessage) get_store()
                                                                                                               .find_element_user(SENDFORWARDMESSAGE$0,
                    0);
     ...
     */
    public void setSendForwardMessage(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageDocument.SendForwardMessage) get_store()
                                                                                                                   .add_element_user(SENDFORWARDMESSAGE$0);
            }
     ...
     * This is a complex type.
     */
    public static class SendForwardMessageImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageDocument.SendForwardMessage {
        private static final javax.xml.namespace.QName HEADER$0 = new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero",
                "header");
        private static final javax.xml.namespace.QName FORWARDMESSAGE$2 = new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero",
                "forwardMessage");
        ...
        public aero.nettracer.serviceprovider.wt_1_0.common.xsd.ForwardMessage getForwardMessage() {
            synchronized (monitor()) {
                ...
                aero.nettracer.serviceprovider.wt_1_0.common.xsd.ForwardMessage target =
                    null;
                target = (aero.nettracer.serviceprovider.wt_1_0.common.xsd.ForwardMessage) get_store()
                                                                                               .find_element_user(FORWARDMESSAGE$2,
                        0);
        ...
        public void setForwardMessage(
            ...
            synchronized (monitor()) {
                ...
                if (target == null) {
                    target = (aero.nettracer.serviceprovider.wt_1_0.common.xsd.ForwardMessage) get_store()
                                                                                                   .add_element_user(FORWARDMESSAGE$2);
                }
