 ...
 */
public class AmendAhlResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.AmendAhlResponseDocument
{
    ...
    private static final javax.xml.namespace.QName AMENDAHLRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "amendAhlResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.AmendAhlResponseDocument.AmendAhlResponse getAmendAhlResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.AmendAhlResponseDocument.AmendAhlResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.AmendAhlResponseDocument.AmendAhlResponse)get_store().find_element_user(AMENDAHLRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAmendAhlResponse(aero.nettracer.serviceprovider.wt_1_0.AmendAhlResponseDocument.AmendAhlResponse amendAhlResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.AmendAhlResponseDocument.AmendAhlResponse)get_store().add_element_user(AMENDAHLRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class AmendAhlResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.AmendAhlResponseDocument.AmendAhlResponse
    {
