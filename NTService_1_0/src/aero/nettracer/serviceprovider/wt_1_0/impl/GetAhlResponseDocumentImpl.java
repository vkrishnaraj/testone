 ...
 */
public class GetAhlResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetAhlResponseDocument
{
    ...
    private static final javax.xml.namespace.QName GETAHLRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "getAhlResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.GetAhlResponseDocument.GetAhlResponse getGetAhlResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.GetAhlResponseDocument.GetAhlResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.GetAhlResponseDocument.GetAhlResponse)get_store().find_element_user(GETAHLRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetAhlResponse(aero.nettracer.serviceprovider.wt_1_0.GetAhlResponseDocument.GetAhlResponse getAhlResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.GetAhlResponseDocument.GetAhlResponse)get_store().add_element_user(GETAHLRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class GetAhlResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetAhlResponseDocument.GetAhlResponse
    {
