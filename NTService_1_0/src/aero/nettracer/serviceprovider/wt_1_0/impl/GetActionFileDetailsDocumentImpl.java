 ...
 */
public class GetActionFileDetailsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsDocument
{
    
    public GetActionFileDetailsDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GETACTIONFILEDETAILS$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "getActionFileDetails");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsDocument.GetActionFileDetails getGetActionFileDetails()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsDocument.GetActionFileDetails target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsDocument.GetActionFileDetails)get_store().find_element_user(GETACTIONFILEDETAILS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGetActionFileDetails(aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsDocument.GetActionFileDetails getActionFileDetails)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsDocument.GetActionFileDetails)get_store().add_element_user(GETACTIONFILEDETAILS$0);
            }
     ...
     * This is a complex type.
     */
    public static class GetActionFileDetailsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.GetActionFileDetailsDocument.GetActionFileDetails
    {
