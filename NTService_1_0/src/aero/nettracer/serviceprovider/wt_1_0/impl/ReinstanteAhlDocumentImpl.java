 ...
 */
public class ReinstanteAhlDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlDocument
{
    ...
    private static final javax.xml.namespace.QName REINSTANTEAHL$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "reinstanteAhl");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlDocument.ReinstanteAhl getReinstanteAhl()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlDocument.ReinstanteAhl target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlDocument.ReinstanteAhl)get_store().find_element_user(REINSTANTEAHL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setReinstanteAhl(aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlDocument.ReinstanteAhl reinstanteAhl)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlDocument.ReinstanteAhl)get_store().add_element_user(REINSTANTEAHL$0);
            }
     ...
     * This is a complex type.
     */
    public static class ReinstanteAhlImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.ReinstanteAhlDocument.ReinstanteAhl
    {
