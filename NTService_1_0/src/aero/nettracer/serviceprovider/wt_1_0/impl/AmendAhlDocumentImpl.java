 ...
 */
public class AmendAhlDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.AmendAhlDocument
{
    ...
    private static final javax.xml.namespace.QName AMENDAHL$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "amendAhl");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.AmendAhlDocument.AmendAhl getAmendAhl()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.AmendAhlDocument.AmendAhl target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.AmendAhlDocument.AmendAhl)get_store().find_element_user(AMENDAHL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAmendAhl(aero.nettracer.serviceprovider.wt_1_0.AmendAhlDocument.AmendAhl amendAhl)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.AmendAhlDocument.AmendAhl)get_store().add_element_user(AMENDAHL$0);
            }
            target.set(amendAhl);
        }
    }
     ...
     * This is a complex type.
     */
    public static class AmendAhlImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.AmendAhlDocument.AmendAhl
    {
