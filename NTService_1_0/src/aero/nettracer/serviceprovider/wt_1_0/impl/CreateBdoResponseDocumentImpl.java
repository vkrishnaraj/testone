 ...
 */
public class CreateBdoResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateBdoResponseDocument
{
    ...
    private static final javax.xml.namespace.QName CREATEBDORESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "createBdoResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.CreateBdoResponseDocument.CreateBdoResponse getCreateBdoResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.CreateBdoResponseDocument.CreateBdoResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.CreateBdoResponseDocument.CreateBdoResponse)get_store().find_element_user(CREATEBDORESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCreateBdoResponse(aero.nettracer.serviceprovider.wt_1_0.CreateBdoResponseDocument.CreateBdoResponse createBdoResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.CreateBdoResponseDocument.CreateBdoResponse)get_store().add_element_user(CREATEBDORESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class CreateBdoResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateBdoResponseDocument.CreateBdoResponse
    {
