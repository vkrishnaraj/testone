 ...
 */
public class CreateOhdDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateOhdDocument
{
    ...
    private static final javax.xml.namespace.QName CREATEOHD$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "createOhd");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.CreateOhdDocument.CreateOhd getCreateOhd()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.CreateOhdDocument.CreateOhd target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.CreateOhdDocument.CreateOhd)get_store().find_element_user(CREATEOHD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCreateOhd(aero.nettracer.serviceprovider.wt_1_0.CreateOhdDocument.CreateOhd createOhd)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.CreateOhdDocument.CreateOhd)get_store().add_element_user(CREATEOHD$0);
            }
     ...
     * This is a complex type.
     */
    public static class CreateOhdImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateOhdDocument.CreateOhd
    {
