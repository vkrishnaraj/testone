 ...
 */
public class PlaceActionFileResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileResponseDocument
{
    
    public PlaceActionFileResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName PLACEACTIONFILERESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "placeActionFileResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileResponseDocument.PlaceActionFileResponse getPlaceActionFileResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileResponseDocument.PlaceActionFileResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileResponseDocument.PlaceActionFileResponse)get_store().find_element_user(PLACEACTIONFILERESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPlaceActionFileResponse(aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileResponseDocument.PlaceActionFileResponse placeActionFileResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileResponseDocument.PlaceActionFileResponse)get_store().add_element_user(PLACEACTIONFILERESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class PlaceActionFileResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileResponseDocument.PlaceActionFileResponse
    {
