 ...
 */
public class CreateOhdResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateOhdResponseDocument
{
    ...
    private static final javax.xml.namespace.QName CREATEOHDRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "createOhdResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.CreateOhdResponseDocument.CreateOhdResponse getCreateOhdResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.CreateOhdResponseDocument.CreateOhdResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.CreateOhdResponseDocument.CreateOhdResponse)get_store().find_element_user(CREATEOHDRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCreateOhdResponse(aero.nettracer.serviceprovider.wt_1_0.CreateOhdResponseDocument.CreateOhdResponse createOhdResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.CreateOhdResponseDocument.CreateOhdResponse)get_store().add_element_user(CREATEOHDRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class CreateOhdResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CreateOhdResponseDocument.CreateOhdResponse
    {
