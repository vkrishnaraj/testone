 ...
 */
public class SendForwardMessageResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageResponseDocument
{
    
    public SendForwardMessageResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SENDFORWARDMESSAGERESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "sendForwardMessageResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageResponseDocument.SendForwardMessageResponse getSendForwardMessageResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageResponseDocument.SendForwardMessageResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageResponseDocument.SendForwardMessageResponse)get_store().find_element_user(SENDFORWARDMESSAGERESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSendForwardMessageResponse(aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageResponseDocument.SendForwardMessageResponse sendForwardMessageResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageResponseDocument.SendForwardMessageResponse)get_store().add_element_user(SENDFORWARDMESSAGERESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class SendForwardMessageResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.SendForwardMessageResponseDocument.SendForwardMessageResponse
    {
        
        public SendForwardMessageResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
