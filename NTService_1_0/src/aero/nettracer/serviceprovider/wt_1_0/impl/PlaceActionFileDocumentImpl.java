 ...
 */
public class PlaceActionFileDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileDocument
{
    ...
    private static final javax.xml.namespace.QName PLACEACTIONFILE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "placeActionFile");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileDocument.PlaceActionFile getPlaceActionFile()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileDocument.PlaceActionFile target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileDocument.PlaceActionFile)get_store().find_element_user(PLACEACTIONFILE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPlaceActionFile(aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileDocument.PlaceActionFile placeActionFile)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileDocument.PlaceActionFile)get_store().add_element_user(PLACEACTIONFILE$0);
            }
     ...
     * This is a complex type.
     */
    public static class PlaceActionFileImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.PlaceActionFileDocument.PlaceActionFile
    {
        ...
        private static final javax.xml.namespace.QName PXF$2 = 
            new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "pxf");
        ...
        public aero.nettracer.serviceprovider.wt_1_0.common.xsd.Pxf getPxf()
        {
            synchronized (monitor())
            {
                ...
                target = (aero.nettracer.serviceprovider.wt_1_0.common.xsd.Pxf)get_store().find_element_user(PXF$2, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setPxf(aero.nettracer.serviceprovider.wt_1_0.common.xsd.Pxf pxf)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (aero.nettracer.serviceprovider.wt_1_0.common.xsd.Pxf)get_store().add_element_user(PXF$2);
                }
                target.set(pxf);
            }
        }
