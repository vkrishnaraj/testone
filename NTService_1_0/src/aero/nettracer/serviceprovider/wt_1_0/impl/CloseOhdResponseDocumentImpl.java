 ...
 */
public class CloseOhdResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CloseOhdResponseDocument
{
    ...
    private static final javax.xml.namespace.QName CLOSEOHDRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "closeOhdResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.CloseOhdResponseDocument.CloseOhdResponse getCloseOhdResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.CloseOhdResponseDocument.CloseOhdResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.CloseOhdResponseDocument.CloseOhdResponse)get_store().find_element_user(CLOSEOHDRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCloseOhdResponse(aero.nettracer.serviceprovider.wt_1_0.CloseOhdResponseDocument.CloseOhdResponse closeOhdResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.CloseOhdResponseDocument.CloseOhdResponse)get_store().add_element_user(CLOSEOHDRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class CloseOhdResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CloseOhdResponseDocument.CloseOhdResponse
    {
