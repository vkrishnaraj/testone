 ...
 */
public class CloseAhlResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CloseAhlResponseDocument
{
    ...
    private static final javax.xml.namespace.QName CLOSEAHLRESPONSE$0 = 
        new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero", "closeAhlResponse");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.CloseAhlResponseDocument.CloseAhlResponse getCloseAhlResponse()
    {
        ...
        {
            check_orphaned();
            aero.nettracer.serviceprovider.wt_1_0.CloseAhlResponseDocument.CloseAhlResponse target = null;
            target = (aero.nettracer.serviceprovider.wt_1_0.CloseAhlResponseDocument.CloseAhlResponse)get_store().find_element_user(CLOSEAHLRESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCloseAhlResponse(aero.nettracer.serviceprovider.wt_1_0.CloseAhlResponseDocument.CloseAhlResponse closeAhlResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (aero.nettracer.serviceprovider.wt_1_0.CloseAhlResponseDocument.CloseAhlResponse)get_store().add_element_user(CLOSEAHLRESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class CloseAhlResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements aero.nettracer.serviceprovider.wt_1_0.CloseAhlResponseDocument.CloseAhlResponse
    {
