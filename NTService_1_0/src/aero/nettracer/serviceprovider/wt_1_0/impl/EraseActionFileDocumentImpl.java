 ...
 */
public class EraseActionFileDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements aero.nettracer.serviceprovider.wt_1_0.EraseActionFileDocument {
    private static final javax.xml.namespace.QName ERASEACTIONFILE$0 = new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero",
            "eraseActionFile");
    ...
    public aero.nettracer.serviceprovider.wt_1_0.EraseActionFileDocument.EraseActionFile getEraseActionFile() {
        synchronized (monitor()) {
            ...
            aero.nettracer.serviceprovider.wt_1_0.EraseActionFileDocument.EraseActionFile target =
                null;
            target = (aero.nettracer.serviceprovider.wt_1_0.EraseActionFileDocument.EraseActionFile) get_store()
                                                                                                         .find_element_user(ERASEACTIONFILE$0,
                    0);
     ...
     */
    public void setEraseActionFile(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (aero.nettracer.serviceprovider.wt_1_0.EraseActionFileDocument.EraseActionFile) get_store()
                                                                                                             .add_element_user(ERASEACTIONFILE$0);
            }
     ...
     * This is a complex type.
     */
    public static class EraseActionFileImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements aero.nettracer.serviceprovider.wt_1_0.EraseActionFileDocument.EraseActionFile {
