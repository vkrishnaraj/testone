 ...
 */
public class EraseActionFileResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements aero.nettracer.serviceprovider.wt_1_0.EraseActionFileResponseDocument {
    private static final javax.xml.namespace.QName ERASEACTIONFILERESPONSE$0 = new javax.xml.namespace.QName("http://wt_1_0.serviceprovider.nettracer.aero",
            "eraseActionFileResponse");

    public EraseActionFileResponseDocumentImpl(
    ...
    public aero.nettracer.serviceprovider.wt_1_0.EraseActionFileResponseDocument.EraseActionFileResponse getEraseActionFileResponse() {
        synchronized (monitor()) {
            ...
            aero.nettracer.serviceprovider.wt_1_0.EraseActionFileResponseDocument.EraseActionFileResponse target =
                null;
            target = (aero.nettracer.serviceprovider.wt_1_0.EraseActionFileResponseDocument.EraseActionFileResponse) get_store()
                                                                                                                         .find_element_user(ERASEACTIONFILERESPONSE$0,
                    0);
     ...
     */
    public void setEraseActionFileResponse(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (aero.nettracer.serviceprovider.wt_1_0.EraseActionFileResponseDocument.EraseActionFileResponse) get_store()
                                                                                                                             .add_element_user(ERASEACTIONFILERESPONSE$0);
            }
     ...
     * This is a complex type.
     */
    public static class EraseActionFileResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
        implements aero.nettracer.serviceprovider.wt_1_0.EraseActionFileResponseDocument.EraseActionFileResponse {
