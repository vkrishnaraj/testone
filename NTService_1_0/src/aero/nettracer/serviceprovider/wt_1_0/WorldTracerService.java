...
public class WorldTracerService {
	...
	public WorldTracerResponse requestOhd(RequestHeader header, ForwardOhd data) {return null;}
	public WorldTracerResponse requestQuickOhd(RequestHeader header, ForwardOhd data) {return null;}
