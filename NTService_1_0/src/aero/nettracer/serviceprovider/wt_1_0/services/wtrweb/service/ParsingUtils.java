...
public class ParsingUtils {
	...
	public static List<ActionFile> parseActionFileSummary(InputStream inStream,	String encoding) throws Exception {
		...
		ArrayList<ActionFile> result = new ArrayList<ActionFile>();
		ActionFile adto= null;
