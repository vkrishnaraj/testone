...
public class MockISharesResponse {
	...
	public static String mockPxfCommand(String command) throws CommandNotProperlyFormedException {
		...
		sb.append("function poponload()\n");
		sb.append("{\n");
		sb.append("testwindow= window.open (\"/cgi-bin/bpass.cgi?Token=EQUIPAJEUS4B01C2FD000A8EBF&\",\"mywindow\",\"location=1,status=1,scrollbars=1,width=1000,menubar=1,left=0,top=400\");\n");
		sb.append("}\n");
		sb.append("function CheckKey(msg,el) {\n");
		sb.append("	if ((document.all.q) && (220==event.keyCode) && (event.shiftKey)){}\n");
		sb.append("  else {\n");
		...
		sb.append("<TD>&nbsp;&nbsp;</TD><TD valign=\"bottom\">\n");
		sb.append("<FORM name=gs action=/cgi-bin/term.cgi method=post>\n");
		sb.append("<input type=hidden name=Token value=EQUIPAJEUS4B01C2FD000A8EBF>\n");
		sb.append("<input type=hidden name=Type value=24>\n");
		sb.append("<textarea onkeydown=CheckKey(this,document.getElementById('q')) rows=24 name=q cols=64>WM PXF XAXUSAP                            /-OK-/16NOV09 2128GMT</textarea><input type=submit value=Send name=btnG style=arial>\n");
		sb.append("<input type=reset value=Reset name=B1 style=arial></FORM></TD>\n");
		sb.append("</TR>	</TBODY></TABLE></th>	</tr><tr>	<th>\n");
		sb.append("<hr color=\"#3366CC\"></th></tr></thead>\n");
		sb.append("<tbody><tr>	<td>\n");
		sb.append("<font face= \" courier \" ><PRE>&GTWM PXF XAXUSAP                            /-OK-/16NOV09 2128GMT \n");
		sb.append("</PRE></td></tr></tbody><tfoot><tr><td><hr color=\"#3366CC\">\n");
		sb.append("</td>	</tr></tfoot></TABLE>\n");
		sb.append(" <td>\n");
		sb.append("  <table  style=\"border-collapse:collapse;border-width:0\" width=100%>\n");
	...
	public static String mockExfSuccessCommand(String command) throws CommandNotProperlyFormedException {
		command = testCommand(command);
		System.out.println("Command: \n" + command);
		StringBuffer sb = new StringBuffer();
		...
		sb.append("<input type=hidden name=Token value=EQUIPAJEUS4B01C2FD000A8EBF>\n");
		sb.append("<input type=hidden name=Type value=24>\n");
		sb.append("<textarea onkeydown=CheckKey(this,document.getElementById('q')) rows=24 name=q cols=64>WM EXF XAXUS AP D1/1                        /-OK-/</textarea><input type=submit value=Send name=btnG style=arial>\n");
		sb.append("<input type=reset value=Reset name=B1 style=arial></FORM></TD>\n");
		sb.append("</TR>	</TBODY></TABLE></th>	</tr><tr>	<th>\n");
		sb.append("<hr color=\"#3366CC\"></th></tr></thead>\n");
		sb.append("<tbody><tr>	<td>\n");
		sb.append("<font face= \" courier \" ><PRE>&GTWM EXF XAXUS AP D1/1                        /-OK-/ \n");
		sb.append("</PRE></td></tr></tbody><tfoot><tr><td><hr color=\"#3366CC\">\n");
		sb.append("</td>	</tr></tfoot></TABLE>\n");
		sb.append(" <td>\n");
		sb.append("  <table  style=\"border-collapse:collapse;border-width:0\" width=100%>\n");
	...
	public static String mockExfFailureCommand(String command) throws CommandNotProperlyFormedException {
		command = testCommand(command);
		System.out.println("Command: \n" + command);
		StringBuffer sb = new StringBuffer();
		...
		sb.append("<input type=hidden name=Token value=EQUIPAJEUS4B01C2FD000A8EBF>\n");
		sb.append("<input type=hidden name=Type value=24>\n");
		sb.append("<textarea onkeydown=CheckKey(this,document.getElementById('q')) rows=24 name=q cols=64>WM EXF XAXUS AP D1/1    /-ITEM NOT FOUND TO ERASE-/</textarea><input type=submit value=Send name=btnG style=arial>\n");
		sb.append("<input type=reset value=Reset name=B1 style=arial></FORM></TD>\n");
		sb.append("</TR>	</TBODY></TABLE></th>	</tr><tr>	<th>\n");
		sb.append("<hr color=\"#3366CC\"></th></tr></thead>\n");
		sb.append("<tbody><tr>	<td>\n");
		sb.append("<font face= \" courier \" ><PRE>&GTWM EXF XAXUS AP D1/1    /-ITEM NOT FOUND TO ERASE-/ \n");
		sb.append("</PRE></td></tr></tbody><tfoot><tr><td><hr color=\"#3366CC\">\n");
		sb.append("</td>	</tr></tfoot></TABLE>\n");
		sb.append(" <td>\n");
		sb.append("  <table  style=\"border-collapse:collapse;border-width:0\" width=100%>\n");
	...
	public static String mockRohCommand(String command) throws CommandNotProperlyFormedException {
		...
		sb.append("function poponload()\n");
		sb.append("{\n");
		sb.append("testwindow= window.open (\"/cgi-bin/bpass.cgi?Token=EQUIPAJEUS4B02C2A0000A9787&\",\"mywindow\",\"location=1,status=1,scrollbars=1,width=1000,menubar=1,left=0,top=400\");\n");
		sb.append("}\n");
		sb.append("function CheckKey(msg,el) {\n");
		sb.append("	if ((document.all.q) && (220==event.keyCode) && (event.shiftKey)){}\n");
		sb.append("  else {\n");
		...
		sb.append("<TD>&nbsp;&nbsp;</TD><TD valign=\"bottom\">\n");
		sb.append("<FORM name=gs action=/cgi-bin/term.cgi method=post>\n");
		sb.append("<input type=hidden name=Token value=EQUIPAJEUS4B02C2A0000A9787>\n");
		sb.append("<input type=hidden name=Type value=24>\n");
		sb.append("<textarea onkeydown=CheckKey(this,document.getElementById('q')) rows=24 name=q cols=64>WM SUS AHL XLFUS10162\n");
		sb.append("AG \n");
		sb.append(" \n");
		...
		sb.append("<hr color=\"#3366CC\"></th></tr></thead>\n");
		sb.append("<tbody><tr>	<td>\n");
		sb.append("<font face= \" courier \" ><PRE>&GTWM SUS AHL XLFUS10162 \n");
		sb.append("AG  \n");
		sb.append("  \n");
		sb.append("</PRE></td></tr></tbody><tfoot><tr><td><hr color=\"#3366CC\">\n");
		sb.append("</td>	</tr></tfoot></TABLE>\n");
	...
	public static String mockRequestQohCommand(String command) throws CommandNotProperlyFormedException {
