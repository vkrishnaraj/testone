...
public class WestJetTest {
	

	private static final String STATION_CODE = "YYC";
	private static final String ENDPOINT = "https://webservice-qa.worldtracer.aero/OnhandBagService/0.1";
	private static final String TAG_2 = "WS123124";
	private static final String TAG_1 = "WS123123";
	...
	public void testQoh() {
		...
		t1.setTagSequence(TAG_1);
		Tag t2 = new Tag();
		t2.setAirlineCode(AIRLINE_CODE);
		t2.setTagSequence(TAG_2);
		...
		try {
			...
			OnhandBagServiceStub stub = new OnhandBagServiceStub(ENDPOINT);
			...
			station.setAirlineCode(AIRLINE_CODE);
