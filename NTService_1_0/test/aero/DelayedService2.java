...
public class DelayedService2 {
	...
	private static final String US_PROD_POLICY_XML = "WS_PROD_policy.xml";
	
	private static final String HTTPS_WEBSERVICE_WORLDTRACER_AERO_INBOX_SERVICE_0_1 = "https://webservice" + qa + ".worldtracer.aero/InboxService/0.1";
...
//
	private void configureClient(org.apache.axis2.client.Stub stub) throws AxisFault {
		...
		try {
			String policy = "/" + US_PROD_POLICY_XML;
...
//		d1.setAgentID("AGENT");
	...
	@Test
	public void testAf() throws AxisFault {
		InboxServiceStub stub = new InboxServiceStub(HTTPS_WEBSERVICE_WORLDTRACER_AERO_INBOX_SERVICE_0_1);
