  ...
  <tr> 
	...
	<spring:message code="pv35" />: <spring:message code="help.phone" />
		...
		<c:forEach items="${incident.items}" var="item" varStatus="status" >
			...
			<div id="right">
				<div align="center"><center><spring:message code="pv36"/></center><p /></div>
				<div class="tools" id="info" style="width: 200px !IMPORTANT;">
		    		<h4><spring:message code="pv23" /></h4>
		    		<ul>
		    			<li><a href="javascript:void(0);" class="statClaimToggle"><strong><spring:message code="claim.status.temporary"/></strong></a><div class="statClaimContent"><spring:message code="pv24" /></div></li>
