...
<%@page import="com.bagnet.nettracer.ws.v1_1.WS_PVPaxCommunication"%>
<%@page import="com.bagnet.nettracer.ws.v1_1.WS_PVIncident"%>
...
%>
 		<c:choose>
			<c:when test="${siteLanguage == 'fr'}">
				<p><strong><spring:message code="pax.want.to.view.new.commnent" /><a href="paxCommunication.htm?prepareto=viewnew&locale=fr">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:when>
			<c:when		test="${(empty siteLanguage) and cookie.userLanguage.value == 'fr'}">
				<p><strong><spring:message code="pax.want.to.view.new.commnent" /><a href="paxCommunication.htm?prepareto=viewnew&locale=fr">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:when>
			<c:otherwise>
				<p><strong><spring:message code="pax.want.to.view.new.commnent" /><a href="paxCommunication.htm?prepareto=viewnew">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:otherwise>
		</c:choose>	
		<!-- 
...
%>
 		<c:choose>
			<c:when test="${siteLanguage == 'fr'}">
				<p><strong><spring:message code="pax.want.to.view.prior.commnent" /><a href="paxCommunication.htm?prepareto=viewprior&locale=fr">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:when>
			<c:when		test="${(empty siteLanguage) and cookie.userLanguage.value == 'fr'}">
				<p><strong><spring:message code="pax.want.to.view.prior.commnent" /><a href="paxCommunication.htm?prepareto=viewprior&locale=fr">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:when>
			<c:otherwise>
				<p><strong><spring:message code="pax.want.to.view.prior.commnent" /><a href="paxCommunication.htm?prepareto=viewprior">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:otherwise>
		</c:choose>	
		<!-- 
...
%>
 		<c:choose>
			<c:when test="${siteLanguage == 'fr'}">
				<p><strong><spring:message code="pax.want.to.send.new.commnent" /><a href="paxCommunication.htm?prepareto=sendnew&locale=fr">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:when>
			<c:when		test="${(empty siteLanguage) and cookie.userLanguage.value == 'fr'}">
				<p><strong><spring:message code="pax.want.to.send.new.commnent" /><a href="paxCommunication.htm?prepareto=sendnew&locale=fr">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:when>
			<c:otherwise>
				<p><strong><spring:message code="pax.want.to.send.new.commnent" /><a href="paxCommunication.htm?prepareto=sendnew">&nbsp;<spring:message code="click.here" /></a></strong></p>
			</c:otherwise>
		</c:choose>	
		<!-- 
