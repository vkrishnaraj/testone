insert into lfcategory (description ,score ,companycode) VALUES ('Laptop/Computer', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Camera', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Cell Phone', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Tablet/E-Reader', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Head Phones', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Wallet/Purse', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Currency/Gift Card/Credit Card', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Book', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Coat/Jacket', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Misc/ Electronic Items', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Music', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Papers', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Jewelry', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Handheld Games', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Optics/Sunglasses', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('Keys', 0,'VX');
insert into lfcategory (description ,score ,companycode) VALUES ('OTHER', 0,'VX');
