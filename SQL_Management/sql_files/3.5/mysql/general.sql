...
update properties set valuestr='ejb:ntfs_internal_local/nt_fs//ClaimClientBeanV3!aero.nettracer.selfservice.fraud.client.ClaimClientRemote' where keystr = 'fraud.server.name';
update properties set valuestr='ejb:ntfs_internal_local/nt_fs//PrivacyPermissionsBean!aero.nettracer.selfservice.fraud.PrivacyPermissionsRemote' where keystr = 'fraud.permissions.server.name';
