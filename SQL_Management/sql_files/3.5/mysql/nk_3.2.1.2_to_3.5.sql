insert into lfcategory (description ,score ,companycode) VALUES ('Laptop/Computer', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Camera', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Cell Phone', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Tablet/E-Reader', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Head Phones', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Wallet/Purse', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Currency/Gift Card/Credit Card', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Book', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Coat/Jacket', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Misc/ Electronic Items', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Music', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Papers', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Jewelry', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Handheld Games', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Optics/Sunglasses', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('Keys', 0,'NK');
insert into lfcategory (description ,score ,companycode) VALUES ('OTHER', 0,'NK');
...
update properties set valuestr ='http://10.8.185.136:8480/NTServices_1_0/services/ReservationService_1_0' where keystr = 'booking.nt.endpoint';
update properties set valuestr ='http://10.8.185.136:8480/NTServices_1_0/services/WorldTracerService' where keystr = 'nt.central.endpoint';