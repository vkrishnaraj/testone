...
insert into systemcomponents (component_id,component_name,component_desc,parent_component_id,component_action_link,display,sort_order,sort_group) VALUES (687,'Payment Approval Process Create'  ,'Allows User to create finances that need to go through the Approval process'  , 59 ,'paymentApproval.do'  ,0  ,104  ,3);
