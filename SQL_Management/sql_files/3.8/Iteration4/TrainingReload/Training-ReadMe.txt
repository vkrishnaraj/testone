...
4) Once the updates are finished. Take a snapshot of that database, rar it up and commit it to the repository. Then upload the snapshot to the DRAPP1 Server at path: D:\deployscripts\swaTrainReload. Be sure to make a back up of the snapshot currently located there just in case.