...
-- NT-2596
update activity set description ='NETTRACER FS MATCH' where code = '601';
...
update activity set display=0 where code in ('9206', '107','288', '223', '592', '590', 'CBP2', 'CBP1', '580', '83', '500', '01F', '578', '579', '208', '210', '278', '301', '312', '224', '289', '221','597','220','238','235','222','302','252','244','232','311','315','112','94','01','102','570','563','562', '85V');
